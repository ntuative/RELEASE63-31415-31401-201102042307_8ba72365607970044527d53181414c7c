package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1799 = param1.invDigit();
         this.var_1798 = this.var_1799 & 32767;
         this.var_2526 = this.var_1799 >> 15;
         this.var_2524 = 131071;
         this.var_2525 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_160) > 0)
         {
