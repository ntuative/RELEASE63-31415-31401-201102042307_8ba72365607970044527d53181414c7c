package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_89:IPurchasableOffer;
      ...
      private var var_569:IWindowContainer;
      
      private var var_325:int = -1;
      
      private const const_1965:int = 10;
      ...
      private const const_1681:uint = 4.293848814E9;
      
      private const const_1680:uint = 4.294967295E9;
      
      private const const_1964:uint = 4.291613146E9;
      ...
      {
         if(this.var_89 == null || this.var_89.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_89.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_89.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_89 is Offer)
            {
               _loc10_ = this.var_89.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_89 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      {
         var _loc1_:IProductData = this._catalog.getProductData(this.var_89.localizationId);
         ...
         var _loc3_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,this.var_89);
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1490 = _loc1_.stuffTypes;
            this.var_682 = _loc1_.boxTypes;
            this.var_683 = _loc1_.ribbonTypes;
            this.var_1050 = this.var_1490[0];
            this.var_326 = this.var_682[0];
            this.var_327 = this.var_683[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_327 < 0)
         {
            this.var_327 = this.var_683.length - 1;
         }
         if(this.var_327 > this.var_683.length - 1)
         {
            this.var_327 = 0;
         }
         if(this.var_326 < 0)
         {
            this.var_326 = this.var_682.length - 1;
         }
         if(this.var_326 > this.var_682.length - 1)
         {
            this.var_326 = 0;
         }
         var _loc1_:int = this.var_682[this.var_326] * 1000 + this.var_683[this.var_327];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_89.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1050,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1312 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1490;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1050);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_682[this.var_326]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_683[this.var_327]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_89,this.var_1313,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_89.offerId,this.var_1313);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_102:
               ...
               if(this.var_2226 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_210)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1965)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2226 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_358:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_325 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_325 + 1);
                     break;
      ...
      {
         if(this.var_238 == null || !this.var_238.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_238.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_325) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_238 == null)
         {
            this.var_238 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_569 == null)
         {
            this.var_569 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_569.procedure = this.suggestionsEventHandler;
         }
         if(this.var_238 == null || this.var_569 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_238.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_569.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_325) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_325);
         }
         this.var_325 = param1;
         if(this.var_325 < 0)
         {
            this.var_325 = _loc2_.numListItems - 1;
         }
         if(this.var_325 >= _loc2_.numListItems)
         {
            this.var_325 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_325) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1964;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1681) : uint(this.const_1680);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_238.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1050;
               }
            }
            _loc4_++;
         }
