package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_362:CatalogViewer;
      
      private var var_363:ICatalogNavigator;
      
      private var var_100:Purse;
      
      private var var_90:RecyclerLogic;
      
      private var var_133:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_225:PurchaseConfirmationDialog;
      
      private var var_304:ChargeConfirmationDialog;
      ...
      private var var_2659:GiftWrappingConfiguration;
      
      private var var_1196:ClubGiftController;
      
      private var var_516:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_225 == null)
            {
               this.var_225 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_225.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_516.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_363.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.var_165 != null && _loc2_)
         {
            this.var_165.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_362.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_363 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_362 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_362.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1889 = param1.session.isPrivateRoom;
               if(this.var_90 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_133 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1196 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_516 == null)
         {
            this.var_516 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_363.buildCatalogIndex(_loc2_);
         if(this.var_770 && this.var_770 != "")
         {
            this.var_363.openPage(this.var_770);
            this.var_770 = "";
            this.var_962 = -1;
         }
         else if(this.var_962 > -1)
         {
            this.var_363.openPageById(this.var_962,this.var_1890);
            this.var_962 = -1;
            this.var_1890 = -1;
            this.var_770 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_362.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_362 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_362.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2658 && this.var_635 != null)
         {
            this.var_635.playSound(HabboSoundTypesEnum.const_1055);
         }
         this.var_2658 = false;
         if(this.var_304 != null)
         {
            this.var_304.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_64,this.var_100.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2660 && this.var_635 != null)
         {
            this.var_635.playSound(HabboSoundTypesEnum.const_1135);
         }
         this.var_2660 = false;
         if(this.var_304 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1196.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_362.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_133 != null)
         {
            this.var_133.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_133 != null)
         {
            this.var_133.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_133 != null)
         {
            this.var_133.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2659 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_225 != null)
         {
            this.var_225.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_133.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_304 == null)
         {
            this.var_304 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_304.showChargeInfo(_loc2_);
      }
