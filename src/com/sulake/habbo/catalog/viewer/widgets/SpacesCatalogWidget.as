package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_203:String = "floor";
      
      private static const const_204:String = "wallpaper";
      ...
      private var var_1584:String = "default";
      ...
      private var var_1585:String = "1.1";
      
      private var var_1758:int = -1;
      
      private var var_1759:int = -1;
      
      private var var_348:BitmapData = null;
      
      private var var_347:BitmapData = null;
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  ...
                  case "wallpaper":
                     for each(_loc10_ in this.var_180.walls.pattern)
                     {
                        ...
                        {
                           this.var_912.push(_loc7_);
                           _loc8_ = true;
                        }
                     }
                     if(_loc8_)
                     {
                        this.var_1378.push(_loc2_);
                     }
                     else
                     {
            ...
            this.changePattern(const_203,0);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1378[this.var_414];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1584);
               }
               break;
            case "ctlg_floor_pattern_prev":
               this.changePattern(const_203,-1);
               break;
            case "ctlg_floor_pattern_next":
               this.changePattern(const_203,1);
               break;
            case "ctlg_floor_color_prev":
               this.changeColor(const_203,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_203,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1380[this.var_413];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1379[this.var_412];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1585);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_912[this.var_414];
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_413];
         ...
         _loc6_ = this.var_1380[this.var_413];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_914[this.var_412];
         for each(_loc1_ in this.var_180.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_492];
               if(_loc13_ != null)
               {
                  this.var_1585 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1379[this.var_412];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_204:
               ...
               if(this.var_414 < 0)
               {
                  this.var_414 = this.var_912.length - 1;
               }
               if(this.var_414 == this.var_912.length)
               {
                  this.var_414 = 0;
               }
               this.var_415 = 0;
               this.var_915 = 0;
               _loc5_ = this.var_912[this.var_414];
               for each(_loc8_ in this.var_180.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_915 = _loc8_.children().length();
                  }
               }
            ...
            case const_203:
               ...
               if(this.var_413 < 0)
               {
                  this.var_413 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_413 >= this._activeFloorPatterns.length)
               {
                  this.var_413 = 0;
               }
               this.var_493 = 0;
               this.var_913 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_413];
               for each(_loc9_ in this.var_180.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_913 = _loc9_.children().length();
                  }
               }
            ...
            case const_93:
               ...
               if(this.var_412 < 0)
               {
                  this.var_412 = this.var_914.length - 1;
               }
               if(this.var_412 >= this.var_914.length)
               {
                  this.var_412 = 0;
               }
               this.var_492 = 0;
               this.var_911 = 0;
               _loc7_ = this.var_914[this.var_412];
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1584,this.var_1585,64,this,"window_romantic_wide");
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_348 != null && this.var_347 != null)
         {
            this.setRoomImage(this.var_348,this.var_347);
         }
      }
   }
}
