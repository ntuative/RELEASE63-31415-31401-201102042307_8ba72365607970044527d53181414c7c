package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IGetImageListener
   {
      ...
      private static const const_1308:int = 20;
      ...
      private var var_945:int = -1;
      
      private var var_506:int = 0;
      
      private var var_618:BitmapData = null;
      
      private var var_1174:BitmapData = null;
      ...
      {
         super(param1);
         this.var_618 = new BitmapData(16,16,true,0);
         this.var_618.fillRect(new Rectangle(2,2,12,12),4278190080);
         this.var_1174 = new BitmapData(16,16,true,4278190080);
      }
      ...
      override public function init() : void
      {
         ...
         this.var_945 = this.getPetTypeIndexFromProduct(_loc3_.localizationId);
         this.initializePetImages();
         this._offers.add(this.var_945,_loc3_);
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_861,this.onApproveNameResult);
      ...
      private function initializePetImages() : void
      {
         ...
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc3_ = _loc2_.avatarRenderManager.petDataManager.getPetData(this.var_945,this);
               if(_loc3_)
               {
                  this.var_637 = _loc3_.sellableBreeds;
               }
            }
         }
         var _loc1_:int = 0;
         while(_loc1_ < const_1308)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc4_.id = _loc1_;
               if(_loc1_ == this.var_506)
               {
                  _loc5_.copyChannel(this.var_618,this.var_618.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
               }
               else
               {
                  _loc5_.copyChannel(this.var_618,this.var_618.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
                  _loc5_.copyChannel(this.var_1174,this.var_1174.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
               }
            }
            _loc1_++;
         }
      ...
      private function onPaletteEntryClick(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = window.findChildByName("palette_" + this.var_506) as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap.copyChannel(this.var_1174,this.var_1174.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
               _loc3_.invalidate();
            }
            _loc2_.bitmap.copyChannel(this.var_618,this.var_618.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
            _loc2_.invalidate();
            this.var_506 = _loc2_.id;
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_945,this.var_506),this.getRaceLocalizationKey(this.var_945,this.var_506));
            }
         }
         return this.getRaceLocalizationKey(this.var_945,this.var_506);
      }
      ...
      private function updateImage() : void
      {
         ...
         var _loc2_:IBreed = this.var_637[this.var_506] as IBreed;
         if(!_loc2_)
         {
            return;
         }
         var _loc4_:int = this.var_506;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var breed:IBreed = this.var_637[this.var_506] as IBreed;
