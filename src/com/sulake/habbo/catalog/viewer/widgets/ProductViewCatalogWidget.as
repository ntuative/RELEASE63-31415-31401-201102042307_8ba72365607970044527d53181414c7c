package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1818:Point;
      
      private var var_502:IItemGridWindow;
      
      private var var_1406:IScrollbarWindow;
      ...
      {
         this.var_936 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1161 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1818 = new Point(this.var_83.x,this.var_83.y);
         this.var_502 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1406 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1817 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_936.text = _loc4_;
         this.var_1161.text = _loc5_;
         this.var_936.height = this.var_936.textHeight + 5;
         this.var_1161.y = this.var_936.y + this.var_936.height;
         this.var_1161.height = Math.max(130,this.var_1161.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_460:
                  _loc6_ = this.var_1817.clone();
                  if(this.var_502 != null)
                  {
                     this.var_502.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_502,this.var_1406,this.var_1507);
                     this.var_502.scrollV = 0;
                  }
                  break;
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_226:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_54);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_47,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_302,AvatarAction.const_438);
                              _loc16_.appendAction(AvatarAction.const_312,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2578)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1818.x;
            this.var_83.y = this.var_1818.y;
            if(param3 != null)
            {
