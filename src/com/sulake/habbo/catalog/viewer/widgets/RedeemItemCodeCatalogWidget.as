package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1099:IButtonWindow;
      
      private var var_1098:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1099.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1098 != null)
         {
            this.var_1098.removeEventListener(WindowKeyboardEvent.const_174,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1099 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1099 != null)
         {
            this.var_1099.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1098 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1098 != null)
         {
            this.var_1098.addEventListener(WindowKeyboardEvent.const_174,this.windowKeyEventProcessor);
         }
      }
