package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1343:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1344:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_165:Dictionary = new Dictionary();
      
      private static const const_955:Object = {"frontpage3":[7,8]};
      
      private static const const_956:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      
      {
         const_165["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_165["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_165["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_165["collectibles"] = ["ctlg_collectibles_link"];
         const_165["club1"] = ["ctlg_text_5"];
         const_165["club_buy"] = ["club_link"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_778.length)
         {
            _loc2_ = String(this.var_778[param1]).replace("#","0x");
