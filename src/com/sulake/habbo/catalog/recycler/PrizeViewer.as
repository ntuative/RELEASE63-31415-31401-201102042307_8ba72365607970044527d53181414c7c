package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_272:IBitmapWrapperWindow;
      ...
      {
         var _loc8_:* = null;
         this.var_272 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_272 != null && !this.var_272.disposed)
         {
            ...
            this.var_272.bitmap = new BitmapData(this.var_272.width,this.var_272.height,true,16777215);
            this.var_272.bitmap.fillRect(this.var_272.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_272.width - param1.width) / 2,(this.var_272.height - param1.height) / 2);
            this.var_272.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
