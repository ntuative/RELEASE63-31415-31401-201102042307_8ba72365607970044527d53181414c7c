package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1167:Number = 0.0;
      
      private var var_749:Point = null;
      ...
      {
         this.var_1166 = [];
         this.var_504 = new Vector3d();
         super();
         this.var_419 = new Map();
         this.var_299 = new Map();
         this.var_617 = new Map();
         this.var_1827 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_299 != null)
         {
            ...
            {
               _loc2_ = this.var_299.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1166)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_817,RoomWidgetChatSelectAvatarMessage.const_753];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_817:
               if(this._container != null && this._container.roomSession != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     {
                        case RoomWidgetChatMessage.const_146:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_753:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc10_ != null)
                  {
                     this._container.moderation.userSelected(_loc10_.method_1,_loc2_.userName);
                  }
               }
         }
         return null;
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_208)
                           {
                              _loc13_ = this.var_299.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_419.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_617.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_208:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_617.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_88,null,this);
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_47);
                                          _loc18_ = _loc17_.getPartColor("ch");
                                          _loc17_.dispose();
                                          if(_loc18_ != null)
                                          {
                                             _loc12_ = uint(_loc18_.rgb);
                                             this.var_617.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_208)
                                    {
                                       this.var_299.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1167 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1167);
            }
            if(this.var_749 == null)
            {
               ...
               this.var_504.y = 0;
               this.var_504.z = 0;
               this.var_749 = _loc4_.getScreenPoint(this.var_504);
               this.var_1167 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_504.x = 0;
            this.var_504.y = 0;
            this.var_504.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_504);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_749.x || _loc8_.y != this.var_749.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_749,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_299)
         {
            _loc2_ = this.var_299.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1166.push(_loc2_);
            }
         }
      }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_88,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_617.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1827.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1827.remove(param1);
         if(_loc3_ != null)
         {
