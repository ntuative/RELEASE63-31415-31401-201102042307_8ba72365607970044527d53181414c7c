package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_618);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_854);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_618:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_854:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_136);
         _loc1_.push(FriendRequestEvent.const_44);
         _loc1_.push(FriendRequestEvent.const_314);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_136:
               ...
               break;
            case FriendRequestEvent.const_44:
            case FriendRequestEvent.const_314:
