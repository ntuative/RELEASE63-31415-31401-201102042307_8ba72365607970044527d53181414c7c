package com.sulake.habbo.ui
{
   ...
   public class PetPackageFurniWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IPetDataListener, IGetImageListener
   {
      ...
      {
         return [RoomWidgetOpenPetPackageMessage.const_856];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetOpenPetPackageMessage.const_856:
      ...
      {
         return [RoomSessionPetPackageEvent.const_555,RoomSessionPetPackageEvent.const_478];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPetPackageEvent.const_555:
                  _loc2_ = param1 as RoomSessionPetPackageEvent;
                  this._objectId = _loc2_.objectId;
                  this.var_555 = _loc2_.figure;
                  this.var_1359 = this.getPetType(this.var_555);
                  _loc4_ = this._container.avatarRenderManager.petDataManager.getPetData(this.var_1359,this);
                  _loc5_ = this.getPetImage(this.var_555);
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_531,this._objectId,_loc5_,-1);
                  this._container.events.dispatchEvent(_loc3_);
                  break;
               case RoomSessionPetPackageEvent.const_478:
                  _loc2_ = param1 as RoomSessionPetPackageEvent;
                  this._objectId = _loc2_.objectId;
                  _loc6_ = _loc2_.nameValidationStatus;
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_474,this._objectId,null,_loc6_);
                  this._container.events.dispatchEvent(_loc3_);
            }
         }
      }
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_328,this._objectId,_loc2_,-1);
         this._container.events.dispatchEvent(_loc3_);
      }
      
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_328,this._objectId,param2,-1);
         this._container.events.dispatchEvent(_loc3_);
      }
      
      public function petDataReady() : void
      {
         this.petImageReady(this.var_555);
      }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc2_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_54,this);
            if(_loc4_ != null)
            {
