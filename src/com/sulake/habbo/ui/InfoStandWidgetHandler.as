   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_150,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_151,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_157,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_150,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_151,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_157,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_556.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_556.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_721);
         _loc1_.push(RoomWidgetUserActionMessage.const_749);
         _loc1_.push(RoomWidgetUserActionMessage.const_628);
         _loc1_.push(RoomWidgetUserActionMessage.const_713);
         _loc1_.push(RoomWidgetUserActionMessage.const_506);
         _loc1_.push(RoomWidgetUserActionMessage.const_798);
         _loc1_.push(RoomWidgetUserActionMessage.const_790);
         _loc1_.push(RoomWidgetUserActionMessage.const_766);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_307);
         _loc1_.push(RoomWidgetFurniActionMessage.const_703);
         _loc1_.push(RoomWidgetFurniActionMessage.const_785);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_847);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_636);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_863);
         _loc1_.push(RoomWidgetUserActionMessage.const_574);
         _loc1_.push(RoomWidgetUserActionMessage.const_837);
         _loc1_.push(RoomWidgetUserActionMessage.const_468);
         _loc1_.push(RoomWidgetUserActionMessage.const_1453);
         _loc1_.push(RoomWidgetPetCommandMessage.const_462);
         _loc1_.push(RoomWidgetPetCommandMessage.const_685);
         _loc1_.push(RoomWidgetUserActionMessage.const_480);
         _loc1_.push(RoomWidgetUserActionMessage.const_395);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_670);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_574)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_395 || param1.type == RoomWidgetUserActionMessage.const_480 || param1.type == RoomWidgetUserActionMessage.const_468)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_625:
               ...
               break;
            case RoomWidgetUserActionMessage.const_721:
               this._container.sessionDataManager.giveRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_480:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_749:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_981,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_713:
               ...
               break;
            case RoomWidgetUserActionMessage.const_506:
               this._container.roomSession.kickUser(_loc3_.method_1);
               break;
            case RoomWidgetUserActionMessage.const_798:
               this._container.roomSession.banUser(_loc3_.method_1);
               break;
            case RoomWidgetUserActionMessage.const_790:
               this._container.roomSession.assignRights(_loc3_.method_1);
               break;
            case RoomWidgetUserActionMessage.const_766:
               this._container.roomSession.removeRights(_loc3_.method_1);
               break;
            ...
            case RoomWidgetUserActionMessage.const_692:
               this._container.sessionDataManager.openHabboHomePage(_loc3_.method_1);
               break;
            ...
            case RoomWidgetFurniActionMessage.const_703:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_307:
            ...
            case RoomWidgetUserActionMessage.const_395:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_847:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_636:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_863:
            ...
            case RoomWidgetUserActionMessage.const_574:
               ...
               break;
            case RoomWidgetUserActionMessage.const_837:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_737);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_331);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1009);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_964);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_208)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.method_1);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_356)
               {
                  _loc12_ = "null";
                  if(_loc11_.method_1 != this._container.sessionDataManager.userId)
                  {
                     _loc12_ = "null";
                  }
               }
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1196)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_563);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_181)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_252)
               {
                  _loc13_.canBeAskedAsFriend = this._container.friendList.canBeAskedForAFriend(_loc11_.method_1);
                  _loc26_ = this._container.friendList.getFriend(_loc11_.method_1);
                  if(_loc26_ != null)
                  {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc32_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_792);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1360;
                  if(!_loc27_)
                  {
                  ...
                  if(!_loc29_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_970;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1599);
               }
               else
               {
                  _loc14_ = this._container.roomSession.userDataManager.getUserBadges(_loc11_.method_1);
               ...
               _loc19_ = _loc11_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_54,_loc19_);
               if(_loc20_ != null)
               {
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_356)
               {
                  _loc33_ = this._container.sessionDataManager.getUserTags(_loc11_.method_1);
                  this.dispatchUserTags(_loc11_.method_1,_loc33_);
               }
               _loc34_ = 0;
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_54,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_556.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_556.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_792);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_54,null);
            if(_loc4_ != null)
            {
