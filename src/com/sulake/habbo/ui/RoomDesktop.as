package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_987:IRoomWidgetFactory = null;
      ...
      private var var_986:IHabboHelp = null;
      ...
      private var var_2441:uint = 16777215;
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_314,this.processEvent);
         }
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_698,this.onRoomContentLoaded);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_55.length)
            {
               _loc5_ = this.var_55.getWithIndex(_loc1_) as IRoomWidget;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_314,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_698,this.onRoomContentLoaded);
         }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_733 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
            if(this.var_733.length > 0)
            {
               this.var_1726 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_103));
            }
         }
         if(this.var_274 != null && this.var_31.state == RoomSessionEvent.const_237)
         {
            this.var_1725 = !this.var_274.showInterstitial();
         }
      ...
      {
         if(this.var_733 == null || this.var_733.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_733.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_733.splice(_loc2_,1);
         }
         if(this.var_733.length == 0)
         {
            this.var_1726 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_987.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(!this.var_55.add(param1,_loc2_))
         {
            _loc2_.dispose();
         }
         switch(param1)
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_731.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_731.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_732.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_732.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_794:
               ...
               if(this.var_801 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_356)
                  {
                     this.var_801.userSelected(_loc7_.method_1,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_300:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_439:
               ...
               break;
            case RoomEngineObjectEvent.const_838:
               if(!this.var_31.isRoomController && !this.var_382.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_139:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1104,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_125:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_873,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_483:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_120,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_532:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1115,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_726);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_804);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_704);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_623);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_311,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2441);
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_311:
               _loc3_ = "null";
               break;
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_291[0],_loc2_.width,_loc2_.height);
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1727) / 1000);
      ...
      {
         if(this.var_15 != null && this.var_31 != null && this.var_1725 && this.var_1726)
         {
            this.var_15.startSession(this.var_31);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_299));
         }
      }
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_373);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_533:
               ...
               this.var_219 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_354,WindowStyle.const_637,WindowParam.const_96) as IToolTipWindow;
               this.var_219.setParamFlag(WindowParam.const_30,false);
      ...
      {
         var _loc3_:IRoomWidget = this.var_55[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IRoomWidget = this.var_55[param1];
         if(_loc2_ == null)
         {
            return const_500;
         }
