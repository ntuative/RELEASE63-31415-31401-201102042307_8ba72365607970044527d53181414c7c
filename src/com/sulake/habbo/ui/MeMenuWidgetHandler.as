   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_280,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_671,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_694,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_165 != null)
            {
               this.var_165.events.removeEventListener(HabboToolbarEvent.const_71,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_425,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_280,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_671,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_694,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_425,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1282)
            {
               _loc3_ = this._container.sessionDataManager.gender;
               _loc4_ = this._container.avatarRenderManager.createAvatarImage(_loc2_,AvatarScaleType.const_54,_loc3_,this);
               if(_loc4_ != null)
               {
                  _loc4_.setDirection(AvatarSetType.const_47,3);
                  _loc1_ = _loc4_.getCroppedImage(AvatarSetType.const_47);
                  _loc4_.dispose();
               }
               this.var_1282 = _loc2_;
               this.var_1565 = _loc1_;
            }
            else
            {
         ...
         if(this.var_165 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_965,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_165.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_880);
         _loc1_.push(RoomWidgetDanceMessage.const_822);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_631);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_819);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_813);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_781);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_769);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_404);
         _loc1_.push(RoomWidgetStopEffectMessage.const_711);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1368);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1149);
         _loc1_.push(RoomWidgetToolbarMessage.const_882);
         _loc1_.push(RoomWidgetToolbarMessage.const_773);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_362);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1366);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_983);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_796);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_839);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_779);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1639);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_852);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_714);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_648);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_340);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetGetEffectsMessage.const_631:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_819:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_813:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_404:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1200)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_187,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_769:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1139:
                        this._catalog.openCatalogPage(CatalogPageName.const_1574,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1072:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_287);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1374:
            ...
            case RoomWidgetStopEffectMessage.const_711:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1149:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_796:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_882:
               ...
               if(this.var_165)
               {
                  this.var_165.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_773:
               ...
               {
                  this.var_165.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_547,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_362:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_488));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_779:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_396,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_852:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_396,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_714:
            ...
            case RoomWidgetAvatarEditorMessage.const_648:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_516));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_340:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_701));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_876));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_425:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_479));
         }
      }
