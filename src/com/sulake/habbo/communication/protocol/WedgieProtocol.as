package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1423:uint = 1;
      
      public static const const_1577:uint = 2;
       
      
      private var var_1349:IProtocolEncoder;
      
      private var var_1038:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1349 = new WedgieEncoder();
         this.var_1038 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1423)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1038.getID(_loc4_);
