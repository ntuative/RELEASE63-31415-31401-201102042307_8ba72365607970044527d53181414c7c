package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_48:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_15:IRoomSessionManager;
      
      private var var_485:IKeyExchange;
      
      private var var_903:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2429:PseudoRandom;
      ...
      private var var_218:HabboHotelView;
      
      private var var_1363:String = "";
      
      private const const_1653:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_598 = param1;
            this.var_48.initConnection(HabboConnectionType.const_229);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_95,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_48 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_48.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_48.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_48.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_48.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_48.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_48.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_48.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_48.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_48.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_48.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_48.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_48.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_48.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_48.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_48.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_48 && this.var_127 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_218 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_127.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_127.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_218.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_127.getKey("use.sso.ticket") == "1";
         this.var_598 = this.var_127.getKey("sso.ticket",null);
         this.var_1719 = this.var_127.getKey("flash.client.url","");
         this.var_2430 = this.var_127.getKey("external.variables.txt","");
         if(this.var_218 == null)
         {
            this.var_218 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_48.mode = HabboConnectionType.const_120;
            if(this.var_598)
            {
               this.var_48.initConnection(HabboConnectionType.const_229);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_558,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_48.mode = HabboConnectionType.const_1002;
            }
         }
         this.var_48.initConnection(HabboConnectionType.const_229);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_48.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_878);
            _loc3_ = new InitCryptoMessageComposer(this.var_48.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2429 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_48.mode)
         {
            case HabboConnectionType.const_120:
               _loc6_ = "";
               _loc6_ = this.var_127.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_127.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1363 = _loc4_;
               this.var_218.loadBannerImage(_loc7_ + "?token=" + this.var_1363,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1002:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1459:
               this.var_903 = this.generateRandomHexString(30);
               this.var_485 = new DiffieHellman(new BigInteger(this.var_127.getKey("connection.development.prime"),16),new BigInteger(this.var_127.getKey("connection.development.generator"),16));
               this.var_485.init(this.var_903);
               _loc8_ = this.var_485.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_48.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_485.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_485.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2429);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1719,this.var_2430));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1653,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_598 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_598);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_177);
         }
      ...
      {
         var _loc4_:IConnection = this.var_48.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_233);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1364)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_186);
         }
         if(param1.type == Event.CLOSE && !this.var_2428)
         {
            _loc2_ = this.var_127.getKey("logout.disconnect.url");
            if(this.var_127.keyExists("facebook.user"))
            {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2428 = true;
         var _loc2_:String = this.var_127.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_127.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1363);
         ...
         var _loc9_:IConnection = this.var_48.getHabboMainConnection(null);
         ...
         this.var_485 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_485.init(_loc14_);
            _loc15_ = this.var_485.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_903 = _loc14_;
            }
