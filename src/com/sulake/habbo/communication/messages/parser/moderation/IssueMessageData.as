package com.sulake.habbo.communication.messages.parser.moderation
{
   public class IssueMessageData
   {
      ...
      public function IssueMessageData(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:String, param9:int, param10:String, param11:int, param12:String, param13:String, param14:int, param15:String, param16:int, param17:String, param18:int, param19:String, param20:String, param21:int, param22:int)
      {
         ...
         this.var_2554 = param7;
         this.var_2552 = param8;
         this.var_1460 = param9;
         this.var_1910 = param10;
         this.var_2156 = param11;
         this.var_2553 = param12;
         this._message = param13;
         this.var_2240 = param14;
         this.var_805 = param15;
         this.var_1846 = param16;
         this.var_2556 = param17;
         this.var_337 = param18;
         this.var_2555 = param19;
         this.var_2026 = param20;
         this.var_2325 = param21;
         this.var_2416 = param22;
      }
      ...
      {
         return this.var_2557 + this.var_2558;
      }
      ...
      {
         var _loc2_:int = (param1 - this.var_1526) / 1000;
