package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc13_ == 1)
            {
               ...
               _loc14_.method_1 = _loc4_;
               _loc14_.userType = RoomObjectTypeEnum.const_356;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_1196;
               _loc14_.method_1 = _loc8_ * -1;
               if(_loc7_.indexOf("/") == -1)
               {
                  _loc14_.figure = _loc7_;
               }
               ...
               _loc14_.sex = UserMessageData.const_1176;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1415;
         }
         return UserMessageData.const_1176;
      }
