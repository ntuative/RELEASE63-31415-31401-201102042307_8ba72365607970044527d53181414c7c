package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_827.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         _loc2_.add(param1.method_1,param1);
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               _loc4_ = _loc3_.remove(_loc2_.method_1);
               if(_loc4_ != null)
               {
               }
            }
      ...
      {
         this.var_827.remove(param1);
         this.var_827.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1235);
      }
      ...
      public function requestPetInfo(param1:int) : void
      {
         ...
         {
            this._connection.send(new GetPetInfoMessageComposer(_loc2_.method_1));
         }
      }
   }
}
