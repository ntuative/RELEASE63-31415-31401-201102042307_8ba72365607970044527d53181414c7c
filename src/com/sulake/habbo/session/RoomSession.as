package com.sulake.habbo.session
{
   ...
   import com.sulake.habbo.communication.messages.outgoing.quest.GiveQuestBadgeMessageEvent;
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1937:int = 2500;
      ...
      {
         if(this._state == RoomSessionEvent.const_237 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1245));
         this.var_1246.add(this.var_1245,getTimer());
         ++this.var_1245;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1246.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1937)
            {
      ...
      {
         this._connection.send(new GiveQuestBadgeMessageEvent(param2,param1));
      }
