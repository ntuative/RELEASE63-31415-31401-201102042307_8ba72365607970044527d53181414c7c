package com.sulake.habbo.session.handler
{
   ...
   public class PetPackageHandler extends BaseHandler
   {
      ...
      private function onOpenPetPackageRequested(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPetPackageEvent(RoomSessionPetPackageEvent.const_555,_loc3_,_loc2_.objectId,_loc2_.figure,0));
         }
      }
      ...
      private function onOpenPetPackageResult(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionPetPackageEvent(RoomSessionPetPackageEvent.const_478,_loc3_,_loc2_.objectId,"",_loc2_.nameValidationStatus));
         }
      }
   }
}
