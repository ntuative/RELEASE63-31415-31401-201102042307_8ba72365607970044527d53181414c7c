package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1527:TriggerConfs;
      
      private var var_1529:ActionTypes;
      
      private var var_1528:ConditionTypes;
      
      private var var_229:Dictionary;
      
      private var var_60:Triggerable;
      
      private var var_663:RoomObjectHightLighter;
      
      private var var_179:UserDefinedRoomEventsHelp;
      
      private var var_1007:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1527 = new TriggerConfs();
         this.var_1529 = new ActionTypes();
         this.var_1528 = new ConditionTypes();
         this.var_229 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_663 = new RoomObjectHightLighter(param1);
         this.var_179 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_229[param1])
         {
            delete this.var_229[param1];
            this.var_663.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_60.furniLimit)
         {
            this.var_229[param1] = param2;
            this.var_663.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.find(this.var_87,"helplink").mouseThreshold = 0;
         this.find(this.var_87,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1007 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_1007.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1007.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_663.hideAll(this.var_229);
         }
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_60 as TriggerDefinition != null)
         {
            this.var_86.send(new UpdateTriggerMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_60 as ActionDefinition != null)
         {
            this.var_86.send(new UpdateActionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_60 as ConditionDefinition != null)
         {
            this.var_86.send(new UpdateConditionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1007.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_179.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_86.send(new ApplySnapshotMessageComposer(this.var_60.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1527);
         this.refreshConfigureElement(this.var_1529);
         this.refreshConfigureElement(this.var_1528);
