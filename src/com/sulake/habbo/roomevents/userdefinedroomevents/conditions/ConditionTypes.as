package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_119.push(new ActorIsOnFurni());
         this.var_119.push(new FurnisHaveAvatars());
         this.var_119.push(new StatesMatch());
         this.var_119.push(new TimeElapsedMore());
         this.var_119.push(new TimeElapsedLess());
         this.var_119.push(new UserCountIn());
         this.var_119.push(new ActorIsInTeam());
         this.var_119.push(new HasStackedFurnis());
         this.var_119.push(new StuffTypeMatches());
      }
