package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class TimeElapsedMore implements ConditionType
   {
      ...
      {
         return ConditionCodes.var_1959;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         var _loc3_:int = this.var_992.getValue();
      ...
      {
         this.var_86 = param2;
         this.var_992 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,1200,1);
