package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1031:SliderWindowController;
      
      private var var_1032:SliderWindowController;
      ...
      {
         return ConditionCodes.var_1956;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1031.getValue());
         _loc2_.push(this.var_1032.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_86 = param2;
         this.var_1031 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1031.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1031.setValue(1);
         this.var_1032 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1032.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1032.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1031.setValue(_loc3_);
         this.var_1032.setValue(_loc4_);
      }
