package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      {
         return int(this.var_1623 * (Number(param1 - this._minValue) / (this.var_1131 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1623 * (this.var_1131 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_904)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_195)
            {
               this.var_904 = false;
            }
         }
         if(!this.var_904 || param1.type != WindowEvent.const_390)
         {
            return;
         }
         if(this.var_600 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_600) * this.var_600;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_600 != 0)
            {
               _loc3_ = this.var_905 + this.var_600;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_691 != null)
            {
               ...
               this.var_1623 = _loc1_.width - _loc2_.width;
            }
         }
