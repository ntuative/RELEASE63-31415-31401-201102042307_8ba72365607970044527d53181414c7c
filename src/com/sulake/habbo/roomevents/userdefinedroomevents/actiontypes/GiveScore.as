package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_992:SliderWindowController;
      
      private var var_991:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_992.getValue());
         _loc2_.push(this.var_991.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_86 = param2;
         this.var_992 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_992.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_992.setValue(1);
         this.var_991 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_991.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_991.setValue(1);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_992.setValue(_loc3_);
         this.var_991.setValue(_loc4_);
      }
