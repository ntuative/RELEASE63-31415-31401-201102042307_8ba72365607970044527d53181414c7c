package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1834:IWindowContainer;
      ...
      private var var_1172:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1834 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1173 = this.var_1834.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1173)
         {
            this.var_1173.procedure = this.onButtonClick;
         }
         this.var_1172 = this.var_1834.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1172)
         {
            this.var_1172.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_259 >= this._localizations.length - 1)
         {
            this.var_1172.disable();
         }
         else
         {
            this.var_1172.enable();
         }
         if(this.var_259 <= 0)
         {
            this.var_1173.disable();
         }
         else
         {
            this.var_1173.enable();
         }
      }
      ...
      {
         ++this.var_259;
         this.var_259 = Math.min(this.var_259,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_259;
         this.var_259 = Math.max(this.var_259,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_259][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_259][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_259][1]).value;
