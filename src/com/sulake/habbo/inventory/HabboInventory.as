package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_989:IRoomSession;
      ...
      private const const_1975:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_95,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_458,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_49.getValue(InventoryCategory.const_81));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_49.getValue(InventorySubCategory.const_286));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_857));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_287));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_49.getValue(InventoryCategory.const_378));
      }
      ...
      {
         return PetsModel(this.var_49.getValue(InventoryCategory.const_155));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_49.getValue(InventoryCategory.const_339) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_95,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_458,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_382 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_165)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_165);
         this.var_49 = new Map();
         ...
         this.var_49.add(InventoryCategory.const_339,_loc1_);
         ...
         this.var_49.add(InventoryCategory.const_857,_loc4_);
         ...
         this.var_49.add(InventoryCategory.const_378,_loc5_);
         ...
         this.var_49.add(InventorySubCategory.const_286,_loc6_);
         ...
         this.var_49.add(InventoryCategory.const_155,_loc8_);
         this.var_183 = true;
         if(this.var_2531)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_286:
               this._view.toggleCategoryView(InventoryCategory.const_81,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_924.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_924.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_924.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_924.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1975);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_671));
      }
