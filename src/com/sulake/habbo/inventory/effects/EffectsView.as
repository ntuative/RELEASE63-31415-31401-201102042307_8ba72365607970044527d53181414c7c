package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      private var var_745:ThumbListManager;
      
      private var var_746:ThumbListManager;
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         this.var_745 = new ThumbListManager(this._assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
         this.var_746 = new ThumbListManager(this._assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",this.getActiveThumbListImageWidth(),this.getActiveThumbListImageHeight());
      ...
      public function updateListViews() : void
      {
         ...
         this.var_746.updateImageFromList();
         this.var_745.updateImageFromList();
         var _loc1_:IBitmapWrapperWindow = this._view.findChildByName("inactive_items_image") as IBitmapWrapperWindow;
         var _loc2_:BitmapData = this.var_746.getListImage();
         ...
         var _loc4_:BitmapData = this.var_745.getListImage();
      ...
      public function updateActionView() : void
      {
         ...
         else if(_loc3_.isActive)
         {
            ...
            this._windowManager.registerLocalizationParameter("inventory.effects.active","itemcount",String(_loc3_.method_2));
         }
         else
         {
            _loc1_.enable();
            ...
            this._windowManager.registerLocalizationParameter("inventory.effects.inactive","itemcount",String(_loc3_.method_2));
         }
      }
      ...
      private function activeThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = this.var_745.resolveIndexFromImageLocation(_loc3_);
      ...
      private function inactiveThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = new Point(WindowMouseEvent(param1).localX,WindowMouseEvent(param1).localY);
            _loc4_ = this.var_746.resolveIndexFromImageLocation(_loc3_);
