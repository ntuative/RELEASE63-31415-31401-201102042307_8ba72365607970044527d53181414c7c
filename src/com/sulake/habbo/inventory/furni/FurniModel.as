package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_371:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_263,this.onObjectPlaced);
         this._catalog = param7;
         this.var_552 = new Timer(const_1225,1);
         this.var_552.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2128 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_263,this.onObjectPlaced);
               }
            ...
            {
               this.var_552.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_552.stop();
               this.var_552 = null;
            }
            if(this.var_188 != null)
            {
               this.var_188.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_188.stop();
               this.var_188 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_399)
         {
         ...
         else if(param3 == FurniCategory.const_376)
         {
         ...
         if(this.var_820 == null)
         {
            this.var_820 = this._windowManager.buildFromXML(this.var_2128) as IWindowContainer;
         }
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_42,const_45];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_188 = new Timer(param1,1);
            this.var_188.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_188.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_81 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_371:
                  this._controller.toggleInventoryPage(InventoryCategory.const_155);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_339);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_42,const_45];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_42,const_45];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_451.add(const_42,new Array());
         this.var_451.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_149)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_286;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_379 || _loc3_.category == FurniCategory.const_399 || _loc3_.category == FurniCategory.const_376)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1276 && param1.type == RoomEngineObjectEvent.const_263)
         {
            this.var_1276 = false;
         }
      }
      ...
      {
         this._catalog.method_4();
      }
      
      public function getCategoryContent(param1:String) : Array
      {
         return this.var_451.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_286:
               ...
               break;
            case InventorySubCategory.const_48:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_451.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_451.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_871)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
