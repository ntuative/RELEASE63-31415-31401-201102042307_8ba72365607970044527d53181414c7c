package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1985:int = 0;
      
      private const const_930:int = 1;
      
      private const const_1674:int = 2;
      
      private const const_1677:int = 3;
      
      private const const_1676:int = 42;
      
      private const const_1675:int = 120;
      ...
      private var var_736:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_464.add(FurniModel.const_42,new FurniGridView(this.var_65,FurniModel.const_42,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_464.add(FurniModel.const_45,new FurniGridView(this.var_65,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_464.getValue(this.var_395);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_65.getCategoryContent(this.var_395);
         if(!this.var_65.isListInited())
         {
            _loc2_ = this.const_930;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1674;
         }
         else
         {
            _loc2_ = this.const_1677;
         }
         if(this.var_2266 == _loc2_)
         {
            return;
         }
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_42,FurniModel.const_45];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_464.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_464.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_464.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_65.getGroupItemInIndex(_loc3_,this.var_395);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_399)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_376)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_149)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_736 && this.var_736.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1675)
         {
            _loc3_ = this.const_1675;
         }
         else if(_loc3_ < this.const_1676)
         {
            _loc3_ = this.const_1676;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_56)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_371);
            }
         }
      }
   }
