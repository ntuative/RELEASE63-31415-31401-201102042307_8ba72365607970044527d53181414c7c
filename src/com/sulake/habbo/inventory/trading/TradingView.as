package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_917:uint = 4284532064;
      
      private static const const_916:uint = 2577770;
      
      public static const const_991:int = 0;
      
      public static const const_1202:int = 1;
      
      public static const const_1183:int = 2;
      ...
      private var var_391:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_391 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_190)
            {
               this.var_190.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_190.stop();
               this.var_190 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(this.var_66 == null)
         {
            this.var_66 = this.createNormalWindow();
         }
         if(this.var_1599 == null)
         {
            this.var_1599 = this.createMinimizedWindow();
         }
         if(!this.var_2200)
         {
            return this.var_66;
      ...
      {
         return this.var_66.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      
      protected function getOtherUsersItemGrid() : IItemGridWindow
      {
         return this.var_66.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            this.updateActionState();
            _loc2_ = this.var_66.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = this.var_22.otherUserName;
            }
            _loc1_ = this.var_66.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_917) : uint(const_916);
            }
            _loc3_ = this.var_66.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = this.var_66.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_917) : uint(const_916);
            }
            _loc3_ = this.var_66.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      public function updateActionState() : void
      {
         ...
         if(this.var_66)
         {
            _loc1_ = this.var_66.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
      ...
      {
         var _loc2_:ITextWindow = this.var_66.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_66.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_66.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         var _loc1_:ITextWindow = this.var_66.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_66.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_66.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_66.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      {
         var _loc1_:ITextWindow = this.var_66.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_66.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_190 = new Timer(1000,3);
            this.var_190.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_190.reset();
         this.var_190.repeatCount = 3;
         this.var_190.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_190.currentCount));
         if(this.var_190.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_149)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1128)
            {
            ...
            this.var_391.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_498);
            this.var_391.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_391.hideDelayed();
         }
      }
