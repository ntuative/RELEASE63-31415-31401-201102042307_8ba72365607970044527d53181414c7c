package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1523:uint = 9;
      
      public static const const_194:uint = 0;
      
      public static const const_169:uint = 1;
      
      public static const const_394:uint = 2;
      
      public static const const_271:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_743 = true;
         this.state = const_169;
         this.var_52.setup(param1,param3,param4,param6);
         this.var_52.updateItemList(this.var_680);
         this.var_52.updateItemList(this.var_1311);
      ...
      public function close() : void
      {
         if(this.var_743)
         {
            if(this._state != const_194 && this._state != const_266)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_681 + " OTHER: " + this.var_1048);
         ...
         {
            case const_194:
               if(param1 == const_169 || param1 == const_266)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      {
         if(this._state == const_394)
         {
            this.state = const_271;
         }
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_52.alertPopup(TradingView.const_1183);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_680)
            {
               this.var_681 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1048 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_52.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_680)
            {
               this.var_52.alertPopup(TradingView.const_1202);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_283.length < const_1523)
         {
