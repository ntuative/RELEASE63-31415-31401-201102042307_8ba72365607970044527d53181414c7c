package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc7_:BitmapData = param1.getPetImage(param2.figure,3,false);
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_41:
               this.var_1459.setSelectedGridItem(this);
               this.var_1458 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1458 = false;
                  this.var_1459.placePetToRoom(this.var_1298.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1974) : uint(this.const_1973);
      }
