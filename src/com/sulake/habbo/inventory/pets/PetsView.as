package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_494:IItemGridWindow;
      ...
      private var var_334:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_494 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_334);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_575.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_494.removeGridItem(_loc2_.window);
         if(this.var_334 == _loc2_)
         {
            this.var_334 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_575 == null || this.var_575.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_575.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_575.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_494.addGridItem(_loc2_.window);
            this.var_575.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_334.pet;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowEvent.const_56)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_65.switchCategory(FurniModel.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_334 != null)
         {
            this.var_334.setSelected(false);
         }
         this.var_334 = param1;
         if(this.var_334 != null)
         {
            this.var_334.setSelected(true);
         }
      ...
      public function getPetImage(param1:String, param2:int, param3:Boolean) : BitmapData
      {
         ...
         if(_loc5_ < 8)
         {
            _loc6_ = this._avatarRenderer.createPetImageFromFigure(param1,AvatarScaleType.const_54,this);
            if(_loc6_ != null)
            {
               ...
               {
                  _loc4_ = _loc6_.getCroppedImage(AvatarSetType.const_47);
               }
               _loc6_.dispose();
            }
         }
