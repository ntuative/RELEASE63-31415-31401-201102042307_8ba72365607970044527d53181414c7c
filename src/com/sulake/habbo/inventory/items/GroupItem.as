package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_835:Boolean;
      
      protected var var_196:Boolean;
      ...
      protected var var_1295:Number;
      
      protected var var_798:int = 0;
      
      protected var var_647:BitmapData;
      
      protected var var_2150:int;
      
      protected var var_1482:Boolean;
      
      protected var var_1981:Boolean;
      
      protected var var_2741:BitmapData;
      
      private const const_1974:int = 8947848;
      
      private const const_1973:int = 13421772;
      
      private const const_1699:Number = 1;
      
      private const const_1698:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1295));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1966);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_798 = _loc1_.id;
         }
         else
         {
      ...
      {
         return this.var_798 == -1;
      }
      
      public function set isSelected(param1:Boolean) : void
      {
         if(this.var_196 != param1)
         {
            this.var_196 = param1;
            this.updateThumbData();
         }
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_871)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1698;
               _loc1_.blend = this.const_1698;
            }
            else
            {
               this._window.blend = this.const_1699;
               _loc1_.blend = this.const_1699;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1981 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2741;
               _loc5_.visible = true;
            }
            else
            {
