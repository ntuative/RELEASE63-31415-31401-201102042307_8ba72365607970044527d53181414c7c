package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_1192:Dictionary;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_425 = new Timer(1000,1);
         this.var_425.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_382.events.addEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_425)
            {
               this.var_425.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_425.reset();
               this.var_425 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_425.running);
         this.var_1192[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1192[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_382.getBadgeImage(param2.badgeId);
            this.var_1192[param2.badgeId] = _loc4_;
         }
