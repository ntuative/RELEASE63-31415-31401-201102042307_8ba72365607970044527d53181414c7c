package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1353:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_586 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_586.width;
         this.var_88 = this.var_586.height;
         this.var_1120 = param5;
         this.var_885 = param6;
         this.var_215 = Math.floor(this.var_1120 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1120,this.var_885);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_587 = this.resolveRowCountFromList();
         if(this.var_587 == 0)
         {
            this.var_26 = new BitmapData(this.var_1120,this.var_885);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_215 * this._thumbWidth,this.var_1120),Math.max(this.var_587 * this.var_88,this.var_885),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_587)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_215)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_26.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_88),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_215 && this.var_26.height < _loc3_.y * this.var_88)
         {
            _loc2_ = new BitmapData(this.var_26.width,this.var_26.height + this.var_88);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_215 - 1),this.var_88);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_215 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_88),null,null,true);
         _loc4_ = new Rectangle(0,this.var_88,this._thumbWidth * (this.var_215 - 1),this.var_26.height - this.var_88);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,this.var_88),null,null,true);
         this.var_26 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1353.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_215));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_215 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_215);
         var _loc3_:int = param1 % this.var_215;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_215)
         {
            return;
         }
         if(param1.y >= this.var_587)
         {
            return;
         }
         var _loc4_:int = this.var_215 - param1.x - 1;
         ...
         if(param1.y < this.var_587 - 1)
         {
            _loc7_ = this.var_26.width - this._thumbWidth;
            _loc8_ = this.var_26.height - (param1.y + 1) * this.var_88;
            ...
            this.var_26.fillRect(new Rectangle(0,this.var_26.height - this.var_88,this.var_26.width,this.var_88),4294967295);
            _loc3_ = new Point(this.var_26.width - this._thumbWidth,_loc2_.y - this.var_88);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == this.var_215 - 1)
            {
               _loc11_ = new BitmapData(this.var_26.width,this.var_26.height - this.var_88);
               _loc2_ = new Rectangle(0,0,this.var_26.width,this.var_26.height - this.var_88);
               _loc11_.copyPixels(this.var_26,_loc2_,new Point(0,0),null,null,true);
               this.var_26 = _loc11_;
               --this.var_587;
            }
         }
         if(this.var_26.height < this.var_885)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_885);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_586.width,this.var_586.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_586.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_586,this.var_586.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
