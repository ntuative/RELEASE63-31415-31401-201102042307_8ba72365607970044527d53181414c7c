package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_452:String = "LEFT";
      
      private var var_145:Number = 50;
      
      private var var_1024:Boolean = true;
      
      private var var_1025:Number = 1;
      
      private var var_1280:Number = 0;
      
      private var var_1564:Number = 15;
      
      private var var_1563:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2749 = new Array();
         ...
         this.var_145 = this._window.width;
         this.var_205 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_1064,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1024 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1024)
         {
         ...
         this._window.context.getDesktopWindow().addEventListener(WindowEvent.const_46,this.onRoomViewResized);
         this.var_1025 = _loc6_.toolbar.@margin_top;
         this.var_1280 = _loc6_.toolbar.@margin_bottom;
         this.var_1564 = _loc6_.toolbar.@min_group_margin;
         this.var_1563 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_303 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_231,param1,param2,this._window,this.var_303);
         this.createGroupsFromXmlList(_loc8_,this.var_554,param1,param2,this.var_205,this.var_303);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_145);
      ...
      public function dispose() : void
      {
         ...
         while(this.var_554.length > 0)
         {
            _loc1_ = this.var_554.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_145,this.var_452,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_452);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_145,this.var_452);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_145,this.var_452);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_554.length)
         {
            _loc2_ = this.var_554[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_205 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_205.x = this.var_145 + this.var_1563;
               this.var_205.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_145;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_145;
               this._window.y = 0;
               this.var_205.x = 0;
               this.var_205.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_145;
               this._window.x = 0;
               this._window.y = 0;
               this.var_205.x = 0;
               this.var_205.y = this.var_145 + this.var_1563;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_145;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_145;
               this.var_205.x = 0;
               this.var_205.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1280;
         _loc4_ -= this.var_1025;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1025;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_231.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1564,(this._window.height - _loc5_ * _loc8_ - this.var_1025 - this.var_1280) / (this.var_231.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1564,(this._window.width - _loc5_ * _loc8_ - this.var_1025 - this.var_1280) / (this.var_231.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_231.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_452;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_554.length)
         {
            _loc3_ = this.var_554[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_145)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_145)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_145)
         {
            return "BOTTOM";
         }
         return null;
