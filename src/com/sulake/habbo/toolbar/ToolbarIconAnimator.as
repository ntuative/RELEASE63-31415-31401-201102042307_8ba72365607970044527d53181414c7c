package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_807.push(_loc11_);
                  this.var_808.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_807.push(new XML());
               this.var_808.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_808[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1260 == true || this.var_810 == 0)
         {
            if(this.var_807.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_807.length)
               {
                  this._frame = 0;
                  ++this.var_810;
               }
      ...
      {
         return this.var_1260 == false && this.var_810 == 1 && this.var_1535 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_808.length)
         {
            _loc2_ = this.var_808[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_809.width),Math.max(param2.height,this.var_809.height));
            _loc3_.copyPixels(this.var_809,this.var_809.rect,new Point(0,0));
