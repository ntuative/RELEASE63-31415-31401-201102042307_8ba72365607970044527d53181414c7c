package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private var var_577:IWindowContainer;
      
      private const const_1678:int = 10;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_1678;
         _loc3_.y = this.const_1678;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_577)
         {
            this.var_577 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
