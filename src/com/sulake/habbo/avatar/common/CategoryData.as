package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_239)
         {
            for each(_loc2_ in this.var_239 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_842 >= 0 && this._parts.length > this.var_842)
         {
            _loc2_ = this._parts[this.var_842];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_239 || this.var_239.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_239[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_239.length <= param1)
         {
            return null;
         }
         return this.var_239[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_842] as AvatarEditorGridPartItem;
      }
