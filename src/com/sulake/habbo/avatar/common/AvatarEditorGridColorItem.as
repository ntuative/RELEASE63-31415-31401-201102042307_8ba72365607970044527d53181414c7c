package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_812:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_668.width,this.var_668.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_668,this.var_668.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1009.width,this.var_1009.height,true,0);
            _loc5_ = this.var_1009.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_812.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_811.width,this.var_811.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_811,this.var_811.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_812)
            {
               switch(this.var_812.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_55:
                     _loc4_.style = HabboIconType.const_867;
                     _loc4_.visible = true;
               }
            }
            else
