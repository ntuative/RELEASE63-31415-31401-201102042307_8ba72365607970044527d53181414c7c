package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseView
   {
      ...
      public function showPalettes(param1:String, param2:int) : void
      {
         ...
         var _loc3_:AvatarEditorGridView = this.var_36[param1] as AvatarEditorGridView;
         if(!_loc3_)
         {
            return;
         }
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_1961);
      ...
      protected function updateGridView() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = this.var_36[this.var_137];
         if(_loc2_ == null)
         {
            return;
         }
