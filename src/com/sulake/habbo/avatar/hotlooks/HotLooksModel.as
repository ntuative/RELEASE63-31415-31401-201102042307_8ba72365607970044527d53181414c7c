package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1784:String = "hot_looks";
      
      public static const const_1714:String = "my_looks";
       
      
      private var var_483:Dictionary;
      
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         super(param1);
         this.var_483 = new Dictionary();
         this.var_483["null"] = new Array();
         this.var_483["null"] = new Array();
         this.var_483["undefined.index"] = 0;
         this.var_483["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_483["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_483[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
