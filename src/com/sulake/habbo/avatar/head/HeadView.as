   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_184,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_250,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_232,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_227,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_267,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_65 && var_137 == "")
         {
            var_65.switchCategory(FigureData.const_184);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_hair":
                  this.switchCategory(FigureData.const_184);
                  break;
               case "tab_hat":
                  this.switchCategory(FigureData.const_250);
                  break;
               case "tab_accessories":
                  this.switchCategory(FigureData.const_232);
                  break;
               case "tab_eyewear":
