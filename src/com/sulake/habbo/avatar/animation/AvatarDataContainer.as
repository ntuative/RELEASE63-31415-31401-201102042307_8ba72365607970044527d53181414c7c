package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1775:Number = 1.0;
      
      private var var_1778:Number = 1.0;
      ...
      {
         super();
         this.var_1698 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2384 = parseInt(_loc2_,16);
         this.var_2382 = parseInt(_loc3_,16);
         ...
         this.var_1886 = new ColorTransform(this.var_1775,this.var_1778,this.var_1774,this._alphaMultiplier);
         this.var_1121 = this.generatePaletteMapForGrayscale(this.var_2382,this.var_2384);
      }
      ...
      {
         return this.var_1121.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1121.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1121.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1121.getValue("alphas") as Array;
      }
