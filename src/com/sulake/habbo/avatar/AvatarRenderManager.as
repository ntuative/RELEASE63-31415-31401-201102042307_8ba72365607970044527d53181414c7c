package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_755:PaletteManager;
      ...
      private var var_1852:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_615 = RenderMode.const_1623;
         this.var_301 = new Map();
         this.var_97 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_111,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_97.add(AvatarType.const_111,_loc4_);
         ...
         this.var_97.add(AvatarType.const_70,_loc4_);
         ...
         this.var_755 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_97 != null)
         {
            for each(_loc1_ in this.var_97.getValues())
            {
               _loc1_.dispose();
            }
            this.var_97.dispose();
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_300.init();
         this.var_755.init();
         _loc2_ = this.var_97.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_97.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_97.getValue(AvatarType.const_111) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_180.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_223 == null)
               {
                  ...
                  _loc6_ = this.var_180.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_180.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_950)
         {
            if(this.var_2620 && this.var_2618 && this.var_2619)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_97.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1852)
         {
            this.var_1852 = new AvatarFigureContainer(this.const_1978);
         }
         this.var_223.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1852,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_301 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_301.getKeys())
         {
            _loc4_ = this.var_301.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_300.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1404)
         {
            _loc6_ = !this.var_300.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_300.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_97.getValue(AvatarType.const_70) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_301.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_97.getValue(AvatarType.const_70);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_301.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_301.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_97.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_97.getValue(AvatarType.const_111) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_111:
               _loc3_ = this.var_97.getValue(AvatarType.const_111) as AvatarStructure;
               break;
            case AvatarType.const_70:
               _loc3_ = this.var_97.getValue(AvatarType.const_70) as AvatarStructure;
               break;
            default:
