package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private var var_158:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_387.getValue(_loc4_) == null)
               {
                  this.var_387.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_458.length > 0)
         {
            _loc1_ = this.var_458.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_387.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
            this.assetsReady(param1,AvatarScaleType.const_54,param2);
         }
         return _loc3_;
      }
      ...
      {
         var _loc4_:PetData = this.var_387.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_387.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_387.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_88)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1299.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_563.getValue(_loc6_) == null)
               {
                  ...
                  this.var_266.push(_loc8_);
                  this.var_563.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_458.indexOf(param3) == -1)
                  {
                     this.var_458.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_563.getKeys())
         {
            _loc5_ = this.var_563.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_266.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
