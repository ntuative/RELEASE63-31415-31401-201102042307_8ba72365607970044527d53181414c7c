   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_216,_windowManager,_assetLibrary);
            ...
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_245,_windowManager,_assetLibrary);
         }
         else
         {
