package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1213:IWindowContainer;
      
      public static var var_1473:IWindowContainer;
      
      public static var var_1961:int = 6710886;
      ...
      private var var_448:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_449:IFrameWindow;
      ...
      private var var_2119:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1020 = [];
         this.var_1271 = [AvatarEditorFigureCategory.const_818,AvatarEditorFigureCategory.const_47,AvatarEditorFigureCategory.const_247,AvatarEditorFigureCategory.const_675,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_101];
         super();
         ...
         if(var_1213 == null)
         {
            ...
            var_1213 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1473 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1473 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_381 = new Timer(1000);
         this.var_381.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1271;
         }
         for each(_loc6_ in param4)
         {
            this.var_1020.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_381.stop();
            this.var_381.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_381 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1271);
         }
         if(param1.length != this.var_1020.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1020.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2121 = this.canChangeOutfit();
            this.var_381.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_448 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_448.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_448.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1020.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_448.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_448.numSelectables)
               {
                  this.var_448.getSelectableAt(_loc6_).x = this.var_448.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1271;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1555 == AvatarEditorSideCategory.const_101 || this.var_2119))
         {
         ...
         this.setViewToCategory(this.var_340);
      }
      ...
      {
         if(this.var_1555 == AvatarEditorSideCategory.const_101)
         {
            this.var_2119 = false;
            this.setSideContent(AvatarEditorSideCategory.const_767);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_767:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_340 = param1;
         this.var_448.setSelected(this.var_448.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_449)
         {
            ...
            this.var_449 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_449.procedure = this.stripClubDialogEventProc;
            this.var_449.center();
         }
         else
         {
