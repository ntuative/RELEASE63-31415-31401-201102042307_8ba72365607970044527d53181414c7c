package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_594:String = "temporary_room";
      
      private static const const_326:int = -1;
      
      private static const const_595:String = "room";
      
      private static const const_938:int = -2;
      
      private static const const_1306:String = "tile_cursor";
      
      private static const const_940:int = -3;
      
      private static const const_1307:String = "selection_arrow";
      
      private static const const_939:String = "overlay";
      
      private static const const_325:String = "object_icon_sprite";
      
      private static const const_414:int = 15;
      ...
      private var var_943:IRoomRendererFactory = null;
      ...
      private var var_750:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_750 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_450.release(new IIDRoomObjectVisualizationFactory());
            this.var_450 = null;
         }
         if(this.var_45 != null)
         {
         ...
         {
            this.var_943.release(new IIDRoomRendererFactory());
            this.var_943 = null;
         }
         ...
         if(this.var_354 != null)
         {
            ...
            {
               _loc2_ = this.var_354.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_354.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_354.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_45 != null)
         {
            ...
            _loc2_ = this.var_45.getRoom(this.getRoomIdentifier(this.var_95,this.var_96));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc11_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_354.length)
         {
            _loc3_ = this.var_354.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_95 || _loc6_ != this.var_96 || !this.var_1168)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_726) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_704) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_804) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_623) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_450 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_450;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_45 != null)
         {
            ...
            this.var_45.addObjectUpdateCategory(RoomObjectCategoryEnum.const_284);
            this.var_45.addObjectUpdateCategory(RoomObjectCategoryEnum.const_73);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_943 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_676,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_127);
         }
         this.initializeRoomManager();
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_676)
         {
            this.var_2596 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_274.events.addEventListener(AdEvent.const_534,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_382;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_25 != null)
         {
            ...
            {
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_222,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_499,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMouseEvent.const_417,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_130,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectStateChangeEvent.const_610,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_139,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_143,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_133,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_122,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_134,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_141,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_135,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_104,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_437,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_548,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_493,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_518,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_551,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_487,this.roomObjectEventHandler);
               ...
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_515,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_450,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_529,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_61,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_513,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectMoveEvent.const_508,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_275,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_564,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_375,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomAdEvent.const_372,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_514,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_985,this.roomObjectEventHandler);
               this.var_25.events.addEventListener(RoomObjectRoomActionEvent.const_501,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_25 == null || this.var_450 == null || this.var_45 == null || this.var_943 == null || this._communication == null || this.var_127 == null || !this.var_2596)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_505 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_816,0,0));
            _loc2_ = 0;
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1059,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_532,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1059);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_621,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_326,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1198,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_875,1,true);
            _loc13_ = parseInt(this.var_127.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1144,_loc13_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_326,const_595,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_875,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_809,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_726,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_804,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_704,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_623,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1125,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_864,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_787,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_732,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_570,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_224);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_772,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_888,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_772,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_888,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1078,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_966,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_938,const_1306,RoomObjectCategoryEnum.const_284);
         _loc7_.createRoomObject(const_940,const_1307,RoomObjectCategoryEnum.const_284);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_326,RoomObjectCategoryEnum.const_73);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_353.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_353.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_864,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_787,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_732,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1554,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1138,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1199,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_354.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_841,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_943.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_995;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_809);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_772);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_888);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1078);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_966);
      ...
      {
         var _loc8_:int = param2 - this.var_1423;
         var _loc9_:int = param3 - this.var_1424;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1168 = true;
               this.var_942 = false;
               this.var_2597 = this.var_1423;
               this.var_2595 = this.var_1424;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1168)
            {
               if(!this.var_942)
               {
                  _loc8_ = param2 - this.var_2597;
                  _loc9_ = param3 - this.var_2595;
                  if(_loc8_ <= -const_414 || _loc8_ >= const_414 || _loc9_ <= -const_414 || _loc9_ >= const_414)
                  {
                     this.var_942 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_96,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_325);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_439,this.var_95,this.var_96,-1,RoomObjectCategoryEnum.const_161));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_73 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_326,const_595);
                     this.var_73.handleRoomObjectEvent(_loc14_,this.var_95,this.var_96);
                  }
               }
            }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_939) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_95,this.var_96,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_96,this.var_1422);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_325);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_325,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1423 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1424 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_96,this.var_1422);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_325);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_95,this.var_96,this.var_1422);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_325);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            return this.var_73.modifyRoomObject(this.var_95,this.var_96,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_73 != null)
         {
            ...
            {
               return this.var_73.modifyWallItemData(this.var_95,this.var_96,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_73.deleteWallItem(this.var_95,this.var_96,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_95,this.var_96);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_875) != 0)
         {
            return false;
         }
         if(this.var_73 != null)
         {
            return this.var_73.initializeRoomObjectInsert(this.var_95,this.var_96,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_73 != null)
         {
            this.var_73.cancelRoomObjectInsert(this.var_95,this.var_96);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_940,RoomObjectCategoryEnum.const_284);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_938,RoomObjectCategoryEnum.const_284);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_220,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_331,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_373,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_990,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1009,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_964,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_300,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_220,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_331,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_373,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_995,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_300,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1039) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1193);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_570,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_768,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_300,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_800,this.var_95,this.var_96,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_73 != null)
         {
            this.var_73.handleRoomObjectEvent(param1,this.var_95,this.var_96);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_220));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_571);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_196,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               _loc8_.addPlane(RoomPlaneData.const_154,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_154,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_278,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_806,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_829,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_885,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_570,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null) : ImageResult
      {
         ...
         _loc8_.id = -1;
         if(!this.var_505 || param1 == null)
         {
            return _loc8_;
         }
         var _loc9_:IRoomInstance = this.var_45.getRoom(const_594);
         if(_loc9_ == null)
         {
            _loc9_ = this.var_45.createRoom(const_594,null);
            if(_loc9_ == null)
            {
               return _loc8_;
            }
         }
         var _loc10_:int = this.var_750.reserveNumber();
         ...
         switch(_loc11_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_220,int(param2));
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_571,param7);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc12_.getModelController().setString(RoomObjectVariableEnum.const_171,param2);
               }
               else
               {
               ...
               break;
            case RoomObjectCategoryEnum.const_73:
         ...
         {
            this.var_1169.add(String(_loc10_),param5);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_1163,param4,true);
         }
         else
         {
            _loc9_.disposeObject(_loc10_,_loc11_);
            this.var_750.freeNumber(_loc10_ - 1);
            _loc8_.id = 0;
         }
         _loc14_.dispose();
         return _loc8_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_95,this.var_96,const_326,RoomObjectCategoryEnum.const_73,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_45.getRoom(const_594);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1163);
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_336,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1006,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_986,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1038,RoomObjectVariableEnum.const_336,param1.clickUrl);
