package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectRoomActionEvent extends RoomObjectEvent
   {
      ...
      public static const const_985:String = "RORAE_LEAVE_ROOM";
      
      public static const const_514:String = "RORAE_CHANGE_ROOM";
      
      public static const const_501:String = "RORAE_TRY_BUS";
