   ...
   public class AnimationStateData
   {
      ...
      public function resetAnimationFrames(param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < this.var_588)
         {
            ...
            this.var_886[_loc2_] = false;
            this.var_887[_loc2_] = false;
            _loc2_++;
         }
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_588)
         {
