package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_365:AnimatedFurnitureVisualizationData = null;
      
      private var _state:int = -1;
      
      private var var_115:AnimationStateData;
      ...
      {
         super();
         this.var_115 = new AnimationStateData();
      }
      ...
      {
         return this.var_115.animationId;
      }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_365 = param1 as AnimatedFurnitureVisualizationData;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_647);
                  this.var_1893 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_647);
                     if(_loc4_ > this.var_1893)
                     {
                        this.var_1893 = _loc4_;
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_115,param1,this._state >= 0);
         }
      }
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               ...
               if(this.var_365.hasAnimation(this.var_1197,_loc6_))
               {
      ...
      {
         return this.var_115.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_115 != null)
         {
            this.var_115.setLayerCount(this.var_588);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(param1 != this.var_1197)
         {
            this.var_1197 = param1;
            this.var_588 = this.var_365.getLayerCount(param1);
      ...
      {
         var _loc2_:* = null;
         if(!this.var_115.animationOver)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_115,param1);
            if(this.var_115.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_115.animationId) || AnimationData.isTransitionToAnimation(this.var_115.animationId))
               {
                  this.setAnimation(this.var_115.animationAfterTransitionId);
                  this.var_115.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         if(_loc3_ == 0)
         {
            _loc3_ = this.var_365.getStartFrame(param2,_loc4_,_direction);
         }
         _loc3_ += 1;
         param1.frameCounter = _loc3_;
         var _loc6_:* = null;
         param1.animationOver = true;
         var _loc7_:int = this.var_588 - 1;
         while(_loc7_ >= 0)
         {
            ...
            if(!_loc8_)
            {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  ...
                  if(_loc11_ == AnimationFrame.const_1028)
                  {
                     _loc10_ = this.var_365.getFrame(param2,_loc4_,_direction,_loc7_,_loc3_);
                  }
                  else
                  {
                     _loc10_ = this.var_365.getFrameFromSequence(param2,_loc4_,_direction,_loc7_,_loc11_,_loc10_.activeSequenceOffset + _loc10_.repeats,_loc3_);
                  }
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_457)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_115.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_115.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
