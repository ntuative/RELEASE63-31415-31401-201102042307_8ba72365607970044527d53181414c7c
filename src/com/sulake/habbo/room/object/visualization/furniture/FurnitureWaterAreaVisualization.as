package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1260:String = "shore";
      ...
      {
         if(this.var_2322 == param1 && this.var_2323 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1260)
            {
               this.var_1662 = _loc2_;
               this.var_2322 = param1;
               this.var_2323 = _direction;
               return this.var_1662;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_471 + 2;
         var _loc4_:int = this.var_581 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1664 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_401.length)
         {
            if(this.var_401[_loc5_] == true)
            {
               this.var_1664 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_582[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_582[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_471 == 0 || this.var_581 == 0)
         {
            ...
            this.var_471 = _loc2_.getNumber(RoomObjectVariableEnum.const_305);
            this.var_581 = _loc2_.getNumber(RoomObjectVariableEnum.const_392);
         }
         this.var_401 = [];
         this.var_582 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_471 * 2 + this.var_581 * 2)
         {
            this.var_401.push(false);
            this.var_582.push(ShoreMaskCreatorUtility.const_77);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_471 + 2;
         var _loc2_:int = this.var_581 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(this.var_67 == null || this.var_67.width < param1 || this.var_67.height < param2)
         {
            if(this.var_67 != null)
            {
               this.var_67.dispose();
            }
            this.var_67 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_67,getSize(param3),this.var_401,this.var_582,assetCollection);
      }
