package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_343:int = 1000;
      ...
      private var var_1033:DirectionData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_232 != null)
         {
            ...
            {
               _loc2_ = this.var_232.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_232.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_232.add(String(_loc7_),_loc3_);
            this.var_1577 = -1;
            this.var_1033 = null;
            _loc5_++;
         }
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_973);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1290 / 2) % 360 / this.var_1290;
         if(this.var_232.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_232.length)
         {
            _loc6_ = int(this.var_232.getKey(_loc5_)) * this.var_1290;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_232.getKey(_loc4_));
         }
         return const_1537;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_232.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_671;
         }
         this.var_1577 = param1;
         this.var_1033 = _loc2_;
         return this.var_1033;
      }
