package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1870:int = 1;
      
      public static const const_1767:int = 16777216;
      ...
      private var var_1796:int = 16777216;
      
      private var var_2768:int = 69069;
      
      private var var_2767:int = 5;
      ...
      public static function getValues(param1:int, param2:int, param3:int) : Array
      {
         ...
         return _randomizer.method_11(param1,param2,param3);
      }
      ...
      public function method_11(param1:int, param2:int, param3:int) : Array
      {
         var _loc4_:* = [];
         var _loc5_:int = 0;
         while(_loc5_ < param1)
      ...
      {
         var _loc1_:int = this.var_2768 * this.var_1795 + this.var_2767;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1796;
         this.var_1795 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1796 * param2);
      }
   }
}
