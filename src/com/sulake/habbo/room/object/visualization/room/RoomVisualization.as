package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_898:int = 16777215;
      
      private static const const_896:int = 13421772;
      
      private static const const_897:int = 10066329;
      
      private static const const_895:int = 10066329;
      
      public static const const_1478:int = 16777215;
      
      public static const const_1479:int = 13421772;
      
      public static const const_1348:int = 10066329;
      ...
      private var var_655:Rectangle = null;
      
      private var var_440:RoomPlaneBitmapMaskParser = null;
      
      private var var_1584:String = null;
      
      private var _floorType:String = null;
      
      private var var_1585:String = null;
      
      private var var_2046:String = null;
      
      private var var_1000:uint = 16777215;
      
      private var var_2043:int = 255;
      
      private var var_2048:int = 255;
      
      private var var_2044:int = 255;
      
      private var var_1510:Boolean = true;
      
      private var var_1509:int = 0;
      
      private var _lastUpdateTime:int = -1000;
      
      private const const_1938:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_440 = new RoomPlaneBitmapMaskParser();
         this.var_275["null"] = false;
         this.var_275["null"] = true;
         this.var_275["null"] = true;
         this.var_275["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_129.length)
            {
               _loc4_ = this.var_129[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_655 = super.boundingRectangle;
         }
         return new Rectangle(this.var_655.x,this.var_655.y,this.var_655.width,this.var_655.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_129.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_129[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1042);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1125);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_203,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_154)
            {
               ...
               {
                  _loc13_.color = const_895;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_898;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_896;
               }
               else
               {
                  _loc13_.color = const_897;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1619)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_112,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1938 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_313.length)
            {
               _loc10_ = this.var_539[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_313[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_93)
               {
                  if(this.var_1510)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2044 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2048 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2043 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1514)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1250 || _loc3_.y != this.var_2042 || _loc3_.z != this.var_2049 || param1.scale != this.var_2047))
            {
               this.var_1250 = _loc3_.x;
               this.var_2042 = _loc3_.y;
               this.var_2049 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_162 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1088);
            if(_loc3_ != this.var_2046)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2046 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_614));
            if(_loc4_ != this.var_1000)
            {
               this.var_1000 = _loc4_;
               this.var_2044 = this.var_1000 & 255;
               this.var_2048 = this.var_1000 >> 8 & 255;
               this.var_2043 = this.var_1000 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1189));
            if(_loc5_ != this.var_1510)
            {
               this.var_1510 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_162 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_829);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_806);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_885);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_629));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_874));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_710));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_129[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_203 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_275["null"] || param2 != this.var_275["null"] || param3 != this.var_275["null"])
         {
            this.var_275["null"] = param1;
            this.var_275["null"] = param2;
            this.var_275["null"] = param3;
            this.var_313 = [];
            this.var_539 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_313;
         if(this.var_313.length == 0)
         {
            _loc6_ = this.var_129;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_313.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_203)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_275[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_313.push(_loc12_);
                        this.var_539.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1509;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_440.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_129.length)
         {
            _loc3_ = this.var_129[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_440.maskCount)
         {
            _loc10_ = this.var_440.getMaskType(_loc8_);
            _loc11_ = this.var_440.getMaskLocation(_loc8_);
            _loc12_ = this.var_440.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_129.length)
               {
                  _loc3_ = this.var_129[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_112 || _loc3_.type == RoomPlane.const_93)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_112 || _loc3_.type == RoomPlane.const_93 && _loc12_ == RoomPlaneBitmapMaskData.const_224)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_129[_loc18_] as RoomPlane;
