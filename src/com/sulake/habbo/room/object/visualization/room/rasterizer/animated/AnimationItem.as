package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class AnimationItem
   {
      ...
      private var var_171:Number = 0.0;
      
      private var var_1396:Number = 0.0;
      ...
      public function AnimationItem(param1:Number, param2:Number, param3:Number, param4:Number, param5:BitmapData)
      {
         ...
         if(isNaN(this.var_171))
         {
            this.var_171 = 0;
         }
         if(isNaN(this.var_1396))
         {
            this.var_1396 = 0;
         }
         if(isNaN(this.var_1395))
         {
            this.var_1395 = 0;
         }
      ...
      public function getPosition(param1:int, param2:int, param3:Number, param4:Number, param5:int) : Point
      {
         ...
         var _loc7_:Number = this.var_171;
         if(param3 > 0)
         {
            _loc6_ += this.var_1396 / param3 * param5 / 1000;
         }
         if(param4 > 0)
         {
            _loc7_ += this.var_1395 / param4 * param5 / 1000;
         }
