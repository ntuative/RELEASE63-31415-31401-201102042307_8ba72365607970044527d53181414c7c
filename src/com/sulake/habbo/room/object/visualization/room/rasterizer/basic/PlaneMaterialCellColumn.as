package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      private var var_703:Vector3d = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_33.length)
            {
               _loc2_ = this.var_33[_loc1_] as PlaneMaterialCell;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_703 != null)
         {
            this.var_703.assign(new Vector3d());
         }
         if(this.var_33 != null)
         {
            _loc1_ = 0;
      ...
      {
         var _loc3_:int = 0;
         if(this._repeatMode == const_831)
         {
            _loc3_ = this.getCellsHeight(this.var_33,param2);
            param1 = _loc3_;
         }
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.height == param1 && Vector3d.isEqual(this.var_703,param2))
               {
                  return this.var_30;
               }
               this.var_30.dispose();
         ...
         this.var_703.assign(param2);
         if(this.var_33.length == 0)
         {
            return this.var_30;
         }
      ...
      {
         if(this.var_33.length == 0 || this.var_30 == null)
         {
            return;
         }
         this.renderCells(this.var_33,0,true,param1);
      }
      ...
      private function renderRepeatAll(param1:IVector3d) : void
      {
         ...
         var _loc2_:int = this.getCellsHeight(this.var_33,param1);
         var _loc3_:int = 0;
         ...
         {
            _loc3_ = this.renderCells(this.var_33,_loc3_,true,param1);
            if(_loc3_ == 0)
            {
               return;
            }
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         var _loc7_:int = 0;
         _loc7_ = 1;
         while(_loc7_ < this.var_33.length - 1)
         {
            _loc2_ = this.var_33[_loc7_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         if(this.var_33.length == 1)
         {
            _loc2_ = this.var_33[0] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
               _loc6_ = _loc2_.getHeight(param1);
               if(_loc6_ > 0)
         ...
         _loc2_ = this.var_33[this.var_33.length - 1] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         var _loc9_:int = 0;
         _loc9_ = 0;
         while(_loc9_ < this.var_33.length >> 1)
         {
            _loc2_ = this.var_33[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         _loc9_ = (this.var_33.length >> 1) + 1;
         while(_loc9_ < this.var_33.length)
         {
            _loc2_ = this.var_33[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         _loc3_ = this.renderCells(this.var_33,_loc3_,false,param1);
         _loc2_ = this.var_33[0] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
