package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1429:int = 0;
      
      public static const const_112:int = 1;
      
      public static const const_203:int = 2;
      ...
      private var var_847:IPlaneRasterizer = null;
      
      private var var_707:PlaneMaskManager = null;
      ...
      private var var_2263:Number = 0;
      
      private var var_2262:Number = 0;
      
      private var var_187:Map = null;
      
      private var var_393:PlaneBitmapData = null;
      ...
      private var var_209:BitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2264 = param10;
         this.var_2263 = param11;
         this.var_2262 = param12;
         this.var_848 = param6;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_847.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_393;
         if(_loc3_ == null)
         {
         ...
         if(this.var_692 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_329))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_847 != null)
            {
               _loc3_ = this.var_847.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1624,this.var_2261,this.var_2264,this.var_2263,this.var_2262,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1514 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1294.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1294[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_141.z - originZ,this.var_103.z - originZ,this.var_81.z - originZ,this.var_104.z - originZ);
            if(this._type == const_93)
            {
               relativeDepth += 0.02;
            }
            this.var_2051 = relativeDepth;
            this._isVisible = true;
            this.var_1514 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2260);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_112 || this._type == const_93)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_112 || this._type == const_93))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_848)
         {
            ...
            {
               _loc4_ = this.var_240[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_848)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_330.length)
            {
               _loc5_ = this.var_330[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_240.length == this.var_846.length)
         {
            while(_loc1_ < this.var_240.length)
            {
               _loc4_ = this.var_240[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_846.length)
                  {
                     _loc7_ = this.var_846[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_330.length > this.var_1324.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_848 || this.var_240.length == 0 && this.var_330.length == 0 && !this.var_329 || this.var_707 == null)
         {
            return;
         }
         ...
         if(this.var_329)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_540);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_240.length)
            {
               _loc3_ = this.var_240[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_67.width - this.var_67.width * _loc3_.leftSideLoc / this.var_276.length;
                  _loc11_ = this.var_67.height - this.var_67.height * _loc3_.rightSideLoc / this.var_277.length;
                  _loc12_ = _loc3_.type;
                  this.var_707.updateMask(this.var_67,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_846.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_330.length)
            {
               _loc4_ = this.var_330[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_67.width - this.var_67.width * _loc4_.leftSideLoc / this.var_276.length;
                  _loc11_ = this.var_67.height - this.var_67.height * _loc4_.rightSideLoc / this.var_277.length;
                  _loc13_ = this.var_67.width * _loc4_.leftSideLength / this.var_276.length;
                  _loc14_ = this.var_67.height * _loc4_.rightSideLength / this.var_277.length;
                  this.var_67.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1324.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_329 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_209 != null && (this.var_209.width != param1.width || this.var_209.height != param1.height))
         {
            this.var_209.dispose();
            this.var_209 = null;
         }
         if(this.var_209 == null)
         {
            this.var_209 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_209.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_209.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_209,this.var_209.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
