package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_931:int = 10;
       
      
      private var var_1745:Vector3d = null;
      
      public function FurniturePushableLogic()
      {
         super();
         moveUpdateInterval = const_660;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_660 / this.getUpdateIntervalValue(_loc3_.state);
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1745.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1745).length == 0)
            {
               if(object.getState(0) != const_932)
               {
                  object.setState(const_932,0);
               }
            }
         }
      }
