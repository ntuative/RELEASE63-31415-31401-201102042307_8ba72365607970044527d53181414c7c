package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_336,"");
         _loc2_.setString(RoomObjectVariableEnum.const_765,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_475,Number(false));
         this.var_777 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1236 > 0 && param1 > this.var_1236)
         {
            this.adDelayTimeout();
            this.var_1236 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1038:
                  _loc2_.setString(RoomObjectVariableEnum.const_336,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_765,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_475,Number(true));
                  this.var_1236 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1144);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_475,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_568)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_765);
            ...
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_568)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_372,_loc5_,_loc6_));
               }
         }
      }
   }
