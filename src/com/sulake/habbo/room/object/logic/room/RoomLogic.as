package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1637:int = 255;
      
      private var var_1377:uint = 16777215;
      
      private var var_1755:int = 255;
      
      private var var_1141:uint = 16777215;
      
      private var var_1757:int = 255;
      
      private var var_1140:int = 0;
      
      private var var_1756:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1042,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_614,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_629,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_874,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_710,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1140)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1637;
            if(_loc2_ - this.var_1140 >= this.var_1756)
            {
               _loc3_ = this.var_1141;
               _loc4_ = this.var_1757;
               this.var_1140 = 0;
            }
            else
            {
               _loc7_ = this.var_1377 >> 16 & 255;
               _loc8_ = this.var_1377 >> 8 & 255;
               _loc9_ = this.var_1377 & 255;
               _loc10_ = this.var_1141 >> 16 & 255;
               _loc11_ = this.var_1141 >> 8 & 255;
               _loc12_ = this.var_1141 & 255;
               _loc13_ = (_loc2_ - this.var_1140) / this.var_1756;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1755 + (this.var_1757 - this.var_1755) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_614,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_864:
               param2.setString(RoomObjectVariableEnum.const_806,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_787:
               param2.setString(RoomObjectVariableEnum.const_829,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_732:
               param2.setString(RoomObjectVariableEnum.const_885,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_570:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_224)
               {
                  _loc5_ = "null";
               }
               this.var_440.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_768:
               _loc4_ = this.var_440.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_440.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1088,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1199:
               param2.setNumber(RoomObjectVariableEnum.const_629,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1138:
               param2.setNumber(RoomObjectVariableEnum.const_874,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_710,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1189,int(param1.bgOnly));
         this.var_1377 = this._color;
         this.var_1755 = this.var_1637;
         this.var_1141 = _loc3_;
         this.var_1757 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_537,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1500,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1583,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1503,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_537,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_196)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_154 || _loc13_ == RoomPlaneData.const_278)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
