package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_638 = this.getKey("url_prefix");
         if(this.var_638 != null && this.var_638.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_638 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function init() : void
      {
         ...
         if(!this.var_777)
         {
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc4_ && _loc4_ != "")
         {
            ...
            _loc6_.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationOverrideError);
         }
         else if(!this.var_777)
         {
            this.var_777 = true;
            if(locked)
            {
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_638 = this.getKey("url.prefix");
         if(this.var_638.length > 0)
         {
            externalAccessDomain = this.var_638.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_1201[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1201[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_638);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         if(this.var_1904.indexOf(param1) < 0 || param3)
         {
            this.var_1201[param1] = param2;
         }
         if(param3)
         {
            this.var_1904.push(param1);
         }
      }
