package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_306:MainViewCtrl;
      
      private var var_639:RoomInfoViewCtrl;
      
      private var var_1204:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_416:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2809:Dictionary;
      ...
      private var var_869:GuestRoomPasswordInput;
      
      private var var_312:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_306 = new MainViewCtrl(this);
         this.var_639 = new RoomInfoViewCtrl(this);
         this.var_1204 = new RoomCreateViewCtrl(this);
         this.var_2002 = new RoomThumbnailRenderer(this);
         this.var_869 = new GuestRoomPasswordInput(this);
         this.var_312 = new GuestRoomDoorbell(this);
         this.var_416 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_318,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_639.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_165.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_180.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_306.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_306.startSearch(Tabs.const_244,Tabs.const_398,param1);
         this.var_306.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_306.startSearch(Tabs.const_277,Tabs.const_236);
         this.var_416.getTab(Tabs.const_277).tabPageDecorator.tabSelected();
      }
