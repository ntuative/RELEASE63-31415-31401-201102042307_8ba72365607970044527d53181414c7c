package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1135:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_606 = new Timer(100);
         this.var_606.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_41 = new Array();
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,104,"a"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,94,"b"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,36,"c"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,84,"d"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"e"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"f"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,416,"i"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,320,"j"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,448,"k"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,352,"l"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,384,"m"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_49,372,"n"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,80,"g"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,74,"h"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,416,"o"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,352,"p"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,304,"q"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,336,"r"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,748,"u"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_62,438,"v"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,540,"t"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,512,"w"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,396,"x"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,440,"y"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,456,"z"));
         this.var_41.push(new RoomLayout(HabboClubLevelEnum.const_55,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_606)
         {
            this.var_606.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_606.reset();
            this.var_606 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1135.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1747 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1747 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1134 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_177.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1134.goBackToInitialState();
         this.var_1134.input.textBackgroundColor = 4294967295;
         this.var_1135 = this.var_41[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < this.var_41.length)
         {
            _loc7_ = this.var_41[_loc4_];
            if(this.isAllowed(_loc7_))
            {
               ...
               this.addThumbnail(_loc3_,this.var_41[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1134.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_41)
         {
      ...
      {
         var _loc2_:String = this.var_1134.getText();
         var _loc3_:String = "model_" + this.var_1135.name;
