package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_501:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_501 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_501.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_501 == null ? 0 : int(this.var_501.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_799;
         }
         if(param1 == 2)
         {
            return Tabs.const_758;
         }
         if(param1 == 3)
         {
            return Tabs.const_755;
         }
         if(param1 == 4)
         {
            return Tabs.const_607;
         }
         return Tabs.const_236;
      }
   }
}
