package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_925:int = 1;
      
      private static const const_587:int = 2;
      
      private static const const_924:int = 3;
      
      private static const const_1259:int = 4;
      ...
      private var var_873:PopularTagsListCtrl;
      
      private var var_872:GuestRoomListCtrl;
      
      private var var_1095:OfficialRoomListCtrl;
      
      private var var_249:ITabContextWindow;
      ...
      private var var_1093:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_873 = new PopularTagsListCtrl(this._navigator);
         this.var_872 = new GuestRoomListCtrl(this._navigator);
         this.var_1095 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_249 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         if(!this.var_249)
         {
         ...
         this.var_192 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_244 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1341 = this.var_17.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_17.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1093 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(!this.var_1093)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1093.procedure = this.onHotelView;
         this.refreshToHotelViewButton(false);
         this.var_17.procedure = this.onWindow;
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_249.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_611,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1620,true);
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_192.y;
         Util.moveChildrenToColumn(this.var_177,["custom_content","list_content"],this.var_213.y,8);
         this.var_192.height = this.var_192.height + _loc1_ - this.var_192.y - this.var_244.height + this.var_2321;
         Util.moveChildrenToColumn(this.var_177,["list_content","custom_footer"],this.var_192.y,0);
         this.var_2321 = this.var_244.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_249.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1661 = true;
            this.var_249.selector.setSelected(_loc1_.button);
         }
      }
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_244);
      ...
      {
         Util.hideChildren(this.var_192);
      ...
      {
         this.refreshList(param1,param2,this.var_872,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_873,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1095,"official_rooms");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         {
            _loc5_ = this.var_192.getChildByName(param4);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_580 == const_925)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_192.blend - _loc2_));
            this.var_192.blend = _loc3_;
            this.var_213.blend = !!this.var_1094 ? Number(_loc3_) : Number(1);
            this.var_244.blend = !!this.var_1094 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_580 = const_587;
            }
         }
         else if(this.var_580 == const_587)
         {
            if(this.var_1342 % 10 == 1)
            {
            ...
            {
               this.var_580 = const_924;
            }
         }
         else if(this.var_580 == const_924)
         {
            this.refresh();
            this.var_580 = const_1259;
         }
         else
         {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_872);
      }
      ...
      {
         this._navigator.refreshButton(this.var_1093,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1093,"icon_hotelview_reactive",param1,null,0);
      }
