package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1691:String = "no_reqs_info";
      ...
      private var var_1829:IContainerButtonWindow;
      
      private var var_1828:IContainerButtonWindow;
      ...
      {
         this.var_1829 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1828 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1828.procedure = this.onDismissAllButtonClick;
         this.var_1829.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_97,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_162)
         {
         ...
         else if(param1.state == FriendRequest.const_365)
         {
         ...
         else if(param1.state == FriendRequest.const_963)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_365;
         ...
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_44,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_314,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_365 && _loc4_.state != FriendRequest.const_346)
            {
               _loc4_.state = FriendRequest.const_346;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_314,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_365 && _loc4_.state != FriendRequest.const_346)
            {
               ...
               _loc4_.state = FriendRequest.const_365;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_44,_loc4_.requestId));
               }
            }
         }
         this._friendList.send(_loc3_);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1829,_loc1_);
         this.setEnabled(this.var_1828,_loc1_);
      }
