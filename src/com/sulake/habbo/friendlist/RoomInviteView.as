package com.sulake.habbo.friendlist
{
   ...
   public class RoomInviteView extends AlertView
   {
      ...
      public function RoomInviteView(param1:HabboFriendList)
      {
         ...
         this.var_196 = param1.categories.getSelectedFriends();
      }
      ...
      {
         friendList.registerParameter("friendlist.invite.summary","count","" + this.var_196.length);
         this.var_899 = ITextFieldWindow(param1.findChildByName("message_input"));
      ...
      private function sendMsg() : void
      {
         ...
         for each(_loc3_ in this.var_196)
         {
