package com.sulake.habbo.friendlist
{
   ...
   public class Util
   {
      ...
      public static function method_6(param1:Array, param2:String = ", ", param3:String = "") : String
      {
         var _loc5_:* = null;
         var _loc4_:String = "";
      ...
      {
         var _loc4_:int = 0;
         Logger.log(param1 + param2 + " (" + param2.width + ", " + param2.height + "), " + param2.getParamFlag(HabboWindowParam.const_60));
