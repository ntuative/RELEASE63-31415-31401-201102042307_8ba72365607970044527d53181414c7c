package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_124:IHabboMessenger;
      ...
      private var var_758:ISessionDataManager;
      
      private var var_2632:FriendListLookAndFeel;
      
      private var var_416:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1860:OpenedToWebPopup;
      
      private var var_2492:int;
      
      var var_94:FriendCategories;
      
      private var var_359:FriendRequests;
      
      private var var_1859:AvatarSearchResults;
      
      private var var_165:IHabboToolbar;
      
      private var var_855:IHabboNotifications;
      
      private var var_624:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2632 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_94 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1859 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_624.stop();
            this.var_624.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_624 = null;
         }
         ...
         if(this.var_124)
         {
            this.var_124.release(new IIDHabboMessenger());
            this.var_124 = null;
         }
         if(this.var_180)
         {
         ...
         if(this.var_855)
         {
            this.var_855.release(new IIDHabboNotifications());
            this.var_855 = null;
         }
         if(this.var_165)
         {
         ...
         if(this.var_758)
         {
            this.var_758.release(new IIDSessionDataManager());
            this.var_758 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(this.var_1860 == null)
         {
            this.var_1860 = new OpenedToWebPopup(this);
         }
         this.var_1860.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_94.findFriend(param1);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_94.getFriendCount(param1,param2);
      }
      
      public function refreshToolBarIcon() : void
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_100,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_359.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_165.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_318,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1014.createAvatarImage(param1,AvatarScaleType.const_88,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_47);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         var _loc1_:String = this.var_180.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_180.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_124 = param2 as IHabboMessenger;
      ...
      {
         this.var_165 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_855 = param2 as IHabboNotifications;
      ...
      {
         this.var_758 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_359 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_94.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_1184,this.getText("friendlist.friends")));
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_351,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_94.addFriend(new Friend(_loc4_));
         }
         this.var_416 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_624)
         {
            this.var_624 = new Timer(120000);
            this.var_624.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_624.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_165.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.FRIENDLIST));
         this.var_165.events.addEventListener(HabboToolbarEvent.const_40,this.onHabboToolbarEvent);
         if(this.var_94.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_94.findCategory(FriendCategory.const_351);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_416.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_357));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_359.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_359.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_416.findTab(FriendListTab.const_97).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_359.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_416.findTab(FriendListTab.const_97);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1859.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      private function onRoomInviteError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = "Received room invite error: errorCode: " + _loc2_.errorCode + ", recipients: " + Util.method_6(_loc2_.failedRecipients);
         new SimpleAlertView(this,"${friendlist.alert.title}",_loc3_).show();
      }
      
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         this.var_94.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_94.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_416.findTab(FriendListTab.const_97);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_758 || !this.var_359)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_758.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_359.vipLimit;
         }
         else if(this.var_758.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_359.clubLimit;
         }
         if(_loc2_ > this.var_359.limit)
         {
            this.var_359.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_94.getAllFriends();
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_158) as IBitmapWrapperWindow;
