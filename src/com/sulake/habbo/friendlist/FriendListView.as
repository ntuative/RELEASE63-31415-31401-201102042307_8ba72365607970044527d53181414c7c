package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1695:String = "noconvinfo";
      
      private static const const_1696:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1446:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1446 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_859 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_244 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1446.prepare(this.var_859);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1103,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1141,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_702,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_608,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_702,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_608,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1447 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1447.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1875 == -1 ? 0 : int(this.var_17.height - this.var_1875);
         var _loc4_:int = this.var_1876 == -1 ? 0 : int(this.var_17.width - this.var_1876);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_244.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1007,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_702,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1103,false);
         ...
         this.var_1875 = this.var_17.height;
         this.var_1876 = this.var_17.width;
