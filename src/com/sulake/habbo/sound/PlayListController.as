package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1976:String = "type_sound_machine";
      
      private const const_1689:String = "type_jukebox";
      
      private var var_635:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_709,this.onSongFinishedPlayingEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_823,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_832,this.onSoundMachineStopEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_666,this.onJukeboxInitEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_550,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_709,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_823,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_832,this.onSoundMachineStopEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_666,this.onJukeboxInitEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_550,this.onDisposeEvent);
               this.var_86 = null;
            }
            if(this.var_417)
            {
      ...
      {
         this.startPlaying(this.const_1976);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(this.var_77 == null || this.var_77.length == 0)
         {
         ...
         if(_loc2_ != null)
         {
            this.var_297 = _loc2_.id;
            this.playSong(this.var_297);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_417[this.var_297] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_417.getValue(this.var_297) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         ...
         _loc2_.volume = this.var_635.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_635.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_297)
         {
      ...
      {
         if(this.var_1811 == this.const_1689)
         {
            this.var_77.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function getNextEntry() : PlayListEntry
      {
         ...
         {
            _loc2_ = this.var_77[_loc3_];
            if(_loc2_.id == this.var_297)
            {
               _loc1_ = _loc3_ + 1;
            }
            _loc3_++;
         }
         if(_loc1_ >= this.var_77.length)
         {
            _loc1_ = 0;
         }
         return this.var_77[_loc1_];
      }
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_614.indexOf(param1) == -1)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_77.length)
            {
               _loc6_ = this.var_77[_loc5_] as PlayListEntry;
               if(_loc6_.id == _loc3_.id)
               {
                  this.var_77.splice(_loc5_,1);
                  _loc4_ = false;
                  break;
               }
               _loc5_++;
         ...
         this.var_614 = this.var_614.splice(this.var_614.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_417[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_635.loadTraxSong(_loc3_.id,_loc3_.data);
