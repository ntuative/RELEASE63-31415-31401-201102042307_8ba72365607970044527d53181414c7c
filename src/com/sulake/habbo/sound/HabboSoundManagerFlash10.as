package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_854:TraxSequencer;
      
      private var var_573:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1180,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_853.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_853.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_465;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_180.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_180.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_572.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_696.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_696,events);
         _loc8_.volume = this.var_465;
         this.var_854 = null;
         this.var_697 = -1;
         if(_loc5_.length != 0)
         {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_855.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_855 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_180 == null || this._connection == null || this._roomEngine == null || this.var_573 != null)
         {
            return;
         }
         this.var_573 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_572.getValue(_loc2_);
         ...
         this.var_572.remove(_loc2_);
         this.var_696.add(_loc3_,_loc6_);
         if(this.var_572.length == 0 && this.var_697 != -1)
         {
            this.var_854.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1180,this.var_697));
            this.var_697 = -1;
            this.var_854 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_573.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1469,this.var_697));
         this.var_697 = -1;
         this.var_854 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_465 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_465 * 100)));
         }
      }
      ...
      {
         this.var_465 = param1;
         this.var_573.updateVolume(this.var_465);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         this.var_165.events.dispatchEvent(_loc2_);
      }
   }
}
