package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1257:String = "pixelbalance";
      
      private static const const_1256:String = "badges";
      
      private static const const_1258:String = "selectbadge";
      
      private static const const_1252:String = "inventory";
      
      private static const const_1253:String = "selectfurni";
      
      private static const const_1251:String = "credits";
      
      private static const const_1255:String = "friendlist";
      
      private static const const_1254:String = "pet_inventory";
      ...
      private var var_702:IHabboToolbar;
      ...
      private var var_863:Map;
      
      private var var_468:HabboNotificationViewManager;
      
      private var var_212:HabboAlertDialogManager;
      
      private var var_701:ParkBusDialogManager;
      
      private var var_2312:Boolean;
      
      private var var_865:ClubGiftNotification;
      
      private var var_862:ClubEndingNotification;
      
      private var var_864:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_863);
         }
         var _loc6_:Map = this.var_863["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_702)
         {
            this.var_702.release(new IIDHabboToolbar());
            this.var_702 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_863["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1083.push(_loc8_);
         return this.var_1083.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1083.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_212 = new HabboAlertDialogManager(this._windowManager,this._localization);
      ...
      {
         this.var_702 = IHabboToolbar(param2);
         this.var_702.events.addEventListener(HabboToolbarEvent.const_71,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_71)
         {
            ...
            this.var_468 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_863["styles"],this.var_863["view"],this.var_702);
            ...
            registerUpdateReceiver(this.var_468,1);
            registerUpdateReceiver(this,2);
            this.var_382.events.addEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImage);
            this.var_702.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1335[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_382);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1335[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1335[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1495,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_382.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1085,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1085,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1585,null);
         }
      }
      
      public function method_9(param1:String, param2:String, param3:String = "") : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc8_:* = null;
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_447.createAvatarImage(param2,AvatarScaleType.const_54);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_382.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_82)
               {
                  _loc9_ = this.var_382.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_382.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1570,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_82:
               ...
               break;
            case CatalogPageMessageProductData.const_226:
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1633)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_862 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_864 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_468.isSpaceAvailable() && this.var_1083.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_468.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1256:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_287);
               }
               break;
            case const_1258:
               break;
            ...
            case const_1254:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_155);
               }
               break;
            case const_1253:
               break;
      ...
      {
         if(param1 != null && this.var_468 != null)
         {
            this.var_468.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_399;
            }
            if(param2 == 3002)
            {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_376;
            }
            return 1;
         }
         return 1;
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_212 == null)
         {
            return;
         }
         this.var_212.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_212.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_212.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_212.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_212.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_701 == null)
         {
            this.var_701 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_701 != null)
         {
            this.var_701.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            _loc4_ = this.getPetImage(_loc2_.figure);
            this.addItem(_loc3_.value,NotificationType.const_1162,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            _loc4_ = this.getPetImage(_loc2_.pet.figure);
            this.addItem(_loc3_.value,NotificationType.const_1162,_loc4_);
         }
      }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this.var_447.createPetImageFromFigure(param1,AvatarScaleType.const_54);
            if(_loc5_ != null)
            {
               _loc5_.setDirection(AvatarSetType.const_34,3);
         ...
         {
            _loc6_ = 0;
            _loc7_ = this._roomEngine.getPetImage(_loc3_,_loc4_,new Vector3d(135),32,null,_loc6_);
            if(_loc7_ != null)
            {
               _loc2_ = _loc7_.data;
            }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2312)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_980,null);
            this.var_2312 = true;
      ...
      {
         if(param2.type == WindowEvent.const_182 || param2.type == WindowEvent.const_645)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_865 && this.var_865.visible)
         {
            return;
         }
         this.var_865 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_980,_loc6_);
      }
   }
}
