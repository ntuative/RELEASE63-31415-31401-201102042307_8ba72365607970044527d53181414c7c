package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1664:String = "badge_bg_001_png";
      
      private const const_1951:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2139 = this._localizations.getBadgeName(this.var_279);
         this.var_2135 = this._localizations.getBadgeDesc(this.var_279);
         this.var_2137 = this._localizations.getAchievementNameForFacebook(this.var_279,this.var_382.userName,this.var_382.realName,this.var_1284);
         this.var_2138 = this._localizations.getAchievementDescForFacebook(this.var_279,this.var_382.userName,this.var_382.realName,this.var_1284);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2136 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1808.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1283.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1283.toString());
         ...
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_2141);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1664);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1951) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1283 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_279,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_279,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_279,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2139);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2135);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2137);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2138);
         this._localizations.registerParameter(param1,"level",this.var_1284.toString());
         this._localizations.registerParameter(param1,"name",this.var_382.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_382.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_382.events.removeEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImageReady);
            this.var_382 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_279)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1664);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_279,this._feedTitleFb,this.var_2136,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2140));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_279,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_279,"client.skip_post"));
               this.dispose();
               return;
         }
      }
