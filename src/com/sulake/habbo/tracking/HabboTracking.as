package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_942:uint = 11;
      ...
      private var var_1179:IHabboWindowManager;
      
      private var var_165:IHabboToolbar;
      
      private var var_179:IHabboHelp;
      ...
      private var var_261:PerformanceTracker = null;
      
      private var var_627:FramerateTracker = null;
      
      private var var_260:LatencyTracker = null;
      
      private var var_625:LagWarningLogger = null;
      
      private var var_626:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_261 = new PerformanceTracker();
         this.var_627 = new FramerateTracker();
         this.var_260 = new LatencyTracker();
         this.var_625 = new LagWarningLogger();
         this.var_626 = new ToolbarClickTracker(this);
         this.var_1433 = new Array(const_942);
         var _loc4_:int = 0;
         while(_loc4_ < const_942)
         {
            this.var_1433[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1428,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1401,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_858,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1201,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1179)
            {
               this.var_1179.release(new IIDHabboWindowManager());
               this.var_1179 = null;
            }
            if(this.var_274)
            {
            ...
            if(this.var_55)
            {
               this.var_55.release(new IIDHabboRoomWidget());
               this.var_55 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_197)
            {
               if(!this.var_197.disposed)
               {
                  ...
                  Component(this.var_197).events.removeEventListener(HabboFriendListTrackingEvent.const_357,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_179)
            {
               ...
               {
                  this.var_179.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_179.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_179.release(new IIDHabboHelp());
               this.var_179 = null;
            }
            if(this.var_165)
            {
               ...
               {
                  this.var_165.events.removeEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
               }
      ...
      {
         this.var_1433[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_180 = IHabboConfigurationManager(param2);
         if(this.var_180)
         {
            if(this.var_260 != null)
            {
               this.var_260.configuration = this.var_180;
            }
            if(this.var_261 != null)
            {
               this.var_261.configuration = this.var_180;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1529);
            if(this.var_180)
            {
               if(this.var_625 != null)
               {
                  this.var_625.configure(this.var_180);
               }
               if(this.var_627 != null)
               {
                  this.var_627.configure(this.var_180);
               }
               if(this.var_626 != null)
               {
                  this.var_626.configure(this.var_180);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_613,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_65,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_454,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_261 != null)
            {
               this.var_261.connection = param1;
            }
            if(this.var_260 != null)
            {
               this.var_260.communication = this._communication;
               this.var_260.connection = param1;
            }
            if(this.var_625 != null)
            {
               this.var_625.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_613)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1393);
         }
         else if(param1.type == HabboHotelViewEvent.const_454)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1425);
         }
         else if(param1.type == HabboHotelViewEvent.const_65)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1449);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1594);
               break;
            case HabboCommunicationEvent.const_878:
               this.trackLoginStep(HabboLoginTrackingStep.const_1526,String(this._communication.port));
               break;
      ...
      {
         this.var_1179 = IHabboWindowManager(param2);
         if(this.var_1179)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_180)
            {
               if(this.var_180.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_180.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1433)
                  {
                  ...
                  if(this.var_261 != null)
                  {
                     _loc4_["null"] = this.var_261.flashVersion;
                     _loc4_["null"] = this.var_261.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1188);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1188,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_197).events.addEventListener(HabboFriendListTrackingEvent.const_357,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_357:
      ...
      {
         this.var_55 = param2 as IRoomWidgetFactory;
         Component(this.var_55).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_55).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_55).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_55).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_179 = param2 as IHabboHelp;
         this.var_179.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_179.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2634)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1606);
            this.var_2634 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1201,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_858,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_274.events.addEventListener(AdEvent.const_534,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_165 = param2 as IHabboToolbar;
         this.var_165.events.addEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_626)
         {
            this.var_626.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_180 != null && !Boolean(this.var_180.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_625.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_510 > -1 && _loc2_ < this.var_510)
         {
            ++this.var_1862;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1862);
         }
         if(this.var_510 > -1 && _loc2_ - this.var_510 > 15000)
         {
            ++this.var_1861;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1861);
         }
         this.var_510 = _loc2_;
         if(this.var_261 != null)
         {
            this.var_261.update(param1,this.var_510);
         }
         if(this.var_260 != null)
         {
            this.var_260.update(param1,this.var_510);
         }
         if(this.var_627 != null)
         {
            this.var_627.trackUpdate(param1,this,this.var_510);
         }
         if(this.var_625 != null)
         {
            this.var_625.update(this.var_510);
         }
      }
   }
}
