package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_64:IItemListWindow;
      
      private var var_144:IFrameWindow;
      
      private var var_553:IWindow;
      
      private var var_204:IBorderWindow;
      
      private var var_1052:TagListRenderer;
      
      private var var_121:IBorderWindow;
      
      private var var_2131:int;
      
      private const const_912:int = 5;
      
      private const const_1662:int = 39;
      
      private const const_1663:int = 7829367;
      
      private const const_1661:int = 16777215;
      
      private const const_1950:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1052 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_50 == null || this.var_204 == null || this.var_64 == null)
         {
            return;
         }
         this.var_64.width = this.var_64.scrollableRegion.width;
         this.var_50.height = this.var_50.scrollableRegion.height;
         this.var_204.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_204.width,this.var_64.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_204.width < this.var_64.width)
         {
            this.var_204.x = this._window.width - this.var_204.width;
            this.var_64.x = 0;
         }
         else
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_204 = this._window.getListItemByName("info_border") as IBorderWindow;
         this.var_64 = this._window.getListItemByName("button_list") as IItemListWindow;
         var _loc3_:* = [];
         this.var_64.groupListItemsWithTag("CMD_BUTTON",_loc3_,true);
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_46,this.onButtonResized);
         }
         if(this.var_204 != null)
         {
            this.var_50 = this.var_204.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_204.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_204.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         {
            _loc7_ = 0;
            while(_loc7_ < this.var_64.numListItems)
            {
               _loc12_ = this.var_64.getListItemAt(_loc7_) as IRegionWindow;
               if(_loc12_ != null)
               {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_204.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_204.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_912;
      ...
      {
         var _loc3_:ITextWindow = this.var_50.getListItemByName("motto_text") as ITextWindow;
         var _loc4_:IWindowContainer = this.var_50.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1663;
            }
            else
            {
               _loc3_.textColor = this.const_1661;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_912;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_358,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_358,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1052.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_181);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_64.getListItemByName(param1) as IRegionWindow;
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_181:
               this.var_64.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_252:
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_64.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_1101:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_970:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2131 > this.const_1950 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2131 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1663;
            if(_loc3_.length >= this.const_1662)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1662 - 1);
            }
         }
      }
      ...
      {
         this.var_144 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_144.center();
         this.var_144.procedure = this.badgesEventProc;
         this.var_144.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_144 && this.var_144.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_553 = null;
         var _loc2_:IItemGridWindow = this.var_144.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_144.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_144.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_553);
               }
               if(_loc3_ <= -1)
               {
                  return;
