package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_189:PetCommandTool;
      
      private var var_1298:Map;
      
      private var var_514:int;
      
      private const const_1960:int = 158;
      
      private const const_1961:int = 16;
      
      private const const_1959:uint = 11184810;
      
      private const const_1956:uint = 6710886;
      
      private const const_1955:uint = 3355443;
      
      private const const_1962:String = "level";
      
      private const const_1954:String = "experience";
      
      private const const_1957:String = "energy";
      
      private const const_1958:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1962,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1954,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1957,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1958,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_514 = param1.id;
         this.var_1298.remove(param1.id);
         this.var_1298.add(param1.id,param1);
         if(this.var_189 && this.var_189.isVisible() && param1.isOwnPet)
         {
            this.var_189.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_189.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1960,this.const_1961,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1959);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1955);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1956);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_189 == null)
         {
            this.var_189 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1298.getValue(this.var_514) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_189.showWindow(true);
            this.var_189.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = this.var_204.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_204.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_189 && this.var_189.getPetId() == this.var_514)
               {
                  this.var_189.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_506,this._widget.petData.ownerId);
