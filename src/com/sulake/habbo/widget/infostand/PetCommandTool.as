package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1979:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1193 = new Map();
         this.var_361 = new Timer(this.const_1979);
         this.var_361.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1193.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1193.getValue(this.var_514) as CommandConfiguration;
      ...
      {
         this.var_1193.remove(param1);
         this.var_1193.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_685,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.setParamFlag(WindowParam.const_96,true);
         this.var_42.context.getDesktopWindow().addEventListener(WindowEvent.const_46,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_426 == null)
         {
            ...
            this.var_426 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_426 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_426.x = 200;
            this.var_426.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_395,this.var_514));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_462,this.var_514,this.var_1879 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_462,this.var_514,this.var_1879 + " " + _loc5_);
