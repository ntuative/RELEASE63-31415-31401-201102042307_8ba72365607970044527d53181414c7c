package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_64.numListItems)
            {
               _loc4_ = this.var_64.getListItemAt(_loc5_);
               _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClicked);
               _loc5_++;
            }
         }
         this.var_954 = this.var_204.findChildByTag("catalog");
         if(this.var_954 != null)
         {
            this.var_954.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         this.var_64.visible = _loc2_ || _loc3_ || _loc4_;
         this.updateWindow();
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_50.addListItem(this.var_954);
            }
            this.var_954.visible = param1;
         }
         else
         {
            this.var_50.removeListItem(this.var_954);
         }
      }
   }
}
