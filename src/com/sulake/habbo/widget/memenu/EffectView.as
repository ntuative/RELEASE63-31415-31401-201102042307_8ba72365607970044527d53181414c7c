package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_168:IWidgetAvatarEffect;
      ...
      {
         super();
         this.var_190 = new Timer(1000);
         this.var_190.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_190.stop();
            this.var_190.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_190 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            if(this.var_168.isActive)
            {
               _loc2_ = this.var_168.secondsLeft / Number(this.var_168.duration);
               this.var_813.width = _loc2_ * this.var_286;
            }
            else
            {
               this.var_813.width = 0;
               this.var_190.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_814.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_814.text;
            if(this.var_168.isActive)
            {
               _loc2_ = this.var_168.secondsLeft;
               ...
               this.var_814.text = _loc1_;
            }
            else
            {
               this.var_814.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_168.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_168.isActive)
         {
         ...
         else
         {
            ...
            this.var_815 = this._window.findChildByName("effect_hilite");
            this.var_815.visible = false;
         }
         this.var_814 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_813 = this._window.findChildByName("loader_bar");
         if(this.var_813 != null)
         {
            this.var_286 = this.var_813.width;
            this.var_190.start();
            this.onUpdate();
         }
         if(this.var_168.icon)
         {
            this.setElementBitmap("effect_icon",this.var_168.icon);
         }
      }
