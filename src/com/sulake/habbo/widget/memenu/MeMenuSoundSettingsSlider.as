package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1063:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1063.volume);
      }
      ...
      {
         if(param1.type != WindowEvent.const_390)
         {
            return;
         }
         this.var_1063.saveVolume(this.getValue(param2.x),false);
      }
