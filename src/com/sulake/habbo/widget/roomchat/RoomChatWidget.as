package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1341:int = 9;
      
      private static const const_954:int = 10;
      
      private static const const_602:int = 25;
      
      private static const const_1219:int = 25;
      
      private static const const_953:int = 4000;
      
      private static const const_1339:int = 6000;
      
      private static const const_1342:int = 3;
      
      private static const const_1340:int = 1;
      
      private static const const_603:int = 8;
      
      private static const const_415:int = 0;
      
      private static const const_952:int = (const_603 + const_415) * const_107 + const_107;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_38 = param1.createWindow("chat_container","",HabboWindowType.const_57,HabboWindowStyle.const_31,HabboWindowParam.const_39,new Rectangle(0,0,200,this.var_226 + RoomChatHistoryPulldown.const_80),null,0) as IWindowContainer;
         this.var_38.background = true;
         this.var_38.color = 33554431;
         this.var_38.tags.push("room_widget_chat");
         this.var_369 = param1.createWindow("chat_contentlist","",HabboWindowType.const_987,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,200,this.var_226),null,0) as IItemListWindow;
         this.var_38.addChild(this.var_369);
         this.var_116 = param1.createWindow("chat_active_content","",HabboWindowType.const_57,HabboWindowStyle.const_39,HabboWindowParam.const_60,new Rectangle(0,0,200,this.var_226),null,0) as IWindowContainer;
         this.var_116.clipping = false;
         this.var_369.addListItem(this.var_116);
         this.var_28 = new RoomChatHistoryViewer(this,param1,this.var_38,param2);
         this.var_2676 = param4.getKey("site.url");
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1200 && this.var_1200 > 0)
         {
            this.var_1200 = -1;
            this.animationStart();
         }
         if(this.var_894)
         {
            _loc2_ = param1 / const_1219 * const_1342;
            if(_loc2_ + this.var_967 > this.var_968)
            {
               _loc2_ = this.var_968 - this.var_967;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_967 >= this.var_968)
            {
               this.var_968 = const_107;
               this.var_967 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1200 = getTimer() + const_953;
            }
         }
         if(this.var_28 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_677,this.onChatMessage);
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_843,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_677,this.onChatMessage);
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_843,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2676);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            ...
            {
               this.var_966 = param1.scale / this.var_1902;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_775.x += param1.positionDelta.x / this.var_966;
            this.var_775.y += param1.positionDelta.y / this.var_966;
         }
         if(param1.rect != null)
         {
            if(this.var_28 == null)
            ...
            this.var_38.height = this.var_226 + this.var_28.pulldownBarHeight;
            this.var_369.width = this.var_38.width - this.var_28.scrollbarWidth;
            this.var_369.height = this.var_226;
            this.var_369.x = this.var_38.x;
            this.var_369.y = this.var_38.y;
            this.var_116.width = this.var_38.width - this.var_28.scrollbarWidth;
            this.var_116.height = this.var_226;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_68.length > const_1340 || this.historyViewerActive() && this.var_68.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_968 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_68[0]);
            }
            else
            {
               this.var_968 = const_107;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(this._itemList.length > 1)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(this.var_776,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = this.var_776;
               if(_loc1_.aboveLevels > const_603 + const_415 + 2)
               {
                  _loc1_.aboveLevels = const_603 + const_415 + 2;
               }
               this.var_776 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_415 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1339)
               {
      ...
      private function moveItemsUp(param1:int) : void
      {
         ...
         var _loc2_:* = null;
         var _loc4_:int = -1;
         var _loc5_:int = this.var_265.length - 1;
         while(_loc5_ >= 0)
         {
            _loc2_ = this.var_265[_loc5_];
            if(_loc2_ != null)
            {
               if(_loc4_ == -1)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_775.x) * this.var_966;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_38.width / 2 - const_954;
         var _loc6_:Number = this.var_38.width / 2 + const_954 - this.var_28.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!this.historyViewerActive() ? 0 : Number(this.var_776);
            if(_loc2_ == this._itemList.length - 1)
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_107 - const_416;
            }
            else
            {
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_226 + this.var_38.y;
      }
      ...
      private function purgeItems() : void
      {
         ...
         while(this._itemList.length > this.var_2678)
         {
            ...
            _loc3_ = this.var_265.indexOf(_loc2_);
            if(_loc3_ > -1)
            {
               this.var_265.splice(_loc3_,1);
            }
            if(_loc2_.view != null)
            {
      ...
      {
         return "chat_" + this.var_2677.toString() + "_item_" + (this.var_2675++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_753,param1,param2,param4,param5);
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_226 = param1 - this.var_38.y;
         this.var_38.height = this.var_226 + RoomChatHistoryPulldown.const_80;
         if(this.var_28 != null)
         {
            this.var_28.containerResized(this.var_38.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_226 = const_952 + const_416;
         this.var_38.height = this.var_226 + this.var_28.pulldownBarHeight;
         this.var_369.width = this.var_38.width - this.var_28.scrollbarWidth;
         this.var_369.height = this.var_226;
         this.var_116.width = this.var_38.width - this.var_28.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_116.height = this.getTotalContentHeight() + const_416;
         }
         else
         {
            this.var_116.height = this.var_226;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1016)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_952)
         {
            if(_loc1_ <= this.var_226 + this.var_38.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
