package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1230:int = 11;
      
      private static const const_582:int = 18;
      
      private static const const_913:int = 16;
      
      private static const const_1229:int = 20;
      ...
      private var var_286:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1029 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2152 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_319 = new Timer(1000,1);
         this.var_319.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_385 = new Timer(10000,1);
         this.var_385.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_319.reset();
            this.var_319.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_319 = null;
         }
         if(this.var_385 != null)
         {
            this.var_385.reset();
            this.var_385.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_385 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_174,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_102,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_390,this.onWindowMoved);
         this.var_1572 = true;
         this.var_453 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_582 + const_913;
         _loc1_.x = const_582;
         _loc1_.y = const_1230;
      }
      ...
      {
         this.var_286 = param1 - (const_582 + const_913);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1029 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_453 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1229);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_453.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_453 = _loc2_.text;
            if(!this.var_557)
            {
               this.var_557 = true;
               this.var_319.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_557);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_286)
         {
