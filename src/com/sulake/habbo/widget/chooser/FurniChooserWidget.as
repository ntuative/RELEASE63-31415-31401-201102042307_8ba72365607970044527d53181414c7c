package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_576:ChooserView;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_131,this.onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_630,this.onUpdateFurniChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_131,this.onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_630,this.onUpdateFurniChooser);
      }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_576 == null)
         {
            this.var_576 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         this.var_576.populate(param1.items,param1.isAnyRoomController);
      }
      
      private function onUpdateFurniChooser(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         if(this.var_576 == null || !this.var_576.isOpen())
         {
            return;
         }
