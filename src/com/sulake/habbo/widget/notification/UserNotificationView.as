package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_1650:String = "button_ok";
      
      protected static const const_1651:String = "text_title";
      
      protected static const DESCRIPTION_NAME:String = "text_description";
      
      protected static const const_1935:String = "widget_notification_frame";
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_640)
            {
               while(this.var_640.length > 0)
               {
                  this.var_640.pop().dispose();
               }
               this.var_640 = null;
            }
            this._widget = null;
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_1651).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_1650).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_640.indexOf(param1);
            if(_loc2_ > -1)
            {
