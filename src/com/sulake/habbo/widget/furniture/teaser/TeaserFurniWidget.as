package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1655:int = 0;
      
      private const const_1656:int = 1;
      
      private const const_1654:int = 2;
      
      private const const_1659:int = 3;
      
      private const const_1660:int = 4;
      
      private const const_1941:int = 0;
      
      private const const_1942:int = 1;
      
      private const const_1947:int = 2;
      
      private const const_1939:int = 3;
      
      private const const_1944:int = 4;
      
      private const const_1943:int = 5;
      
      private const const_1657:String = "deco_img";
      
      private const const_1658:String = "dialog_bg";
      
      private const const_1945:String = "%campaign%_dialog_bg.png";
      
      private const const_323:String = "%campaign%_gift_package.png";
      
      private const const_1946:String = "%campaign%_gift_content.png";
      
      private const const_1940:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         this._imageUrlPath = this.var_127.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function dispose() : void
      {
         ...
         this.hideInterface();
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1263.length)
         {
            _loc2_ = this.var_1263.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_127 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_426,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_744,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_615,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_426,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_426:
               _loc2_ = this.const_1655;
               this.var_1010 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_615:
               ...
               {
                  _loc2_ = this.const_1660;
               }
               this.var_1010 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_744:
               _loc2_ = this.const_1656;
               this._objectId = param1.objectId;
               this.var_1010 = param1.data;
         ...
         if(this._window && (this.var_1262 != _loc2_ || _loc3_ != this.var_167))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_167 = _loc3_;
         this.var_1262 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1262)
            {
               case this.const_1655:
                  ...
                  break;
               case this.const_1656:
                  if(this.var_374 == this.const_1941)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_167,"client.show.locked");
                     _loc2_ = this.const_323;
                  }
                  else if(this.var_374 == this.const_1942)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_167,"client.show.unlocked");
                     _loc2_ = this.const_1946;
                  }
                  else if(this.var_374 == this.const_1947)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_167,"client.show.no_fb");
                  ...
                  else if(this.var_374 == this.const_1939)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_167,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_374 == this.const_1944)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_167,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_374 == this.const_1943)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_167,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_1945.replace("%campaign%",this.var_167);
            this.setDecoImage(_loc5_,this.const_1658);
            _loc2_ = _loc2_.replace("%campaign%",this.var_167);
            this.setDecoImage(_loc2_,this.const_1657);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_716);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_167,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_167,"client.start_post",this.var_1010);
         var _loc4_:String = this.var_127.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_167,_loc2_,_loc3_,this.var_1010,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_152);
            _loc2_.objectId = this._objectId;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
         this.sendConversionPoint("viral_" + this.var_167,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_869,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1263.push(new ImageDownloader(this,_assets,this.var_167,this._imageUrlPath,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_1658:
            case this.const_1657:
      ...
      {
         if(!this._window || this.var_167 != param1.campaignID)
         {
            return;
         }
