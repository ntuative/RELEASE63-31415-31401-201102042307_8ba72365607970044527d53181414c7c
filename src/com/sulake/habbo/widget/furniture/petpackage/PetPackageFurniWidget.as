package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      private var var_933:BitmapData;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_531,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_474,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_328,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_531,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_474,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_328,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_531:
               this.hideInterface();
               this._objectId = event.objectId;
               this.var_933 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_474:
               if(!this.var_1158)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_328:
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("petpackage_container","",HabboWindowType.const_57,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1211,const_1212,2,2),null,0) as IWindowContainer;
      ...
      {
         if(this.var_933 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc1_.bitmap.copyPixels(this.var_933,this.var_933.rect,new Point(0,0));
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1158 || this._objectId == -1)
         {
            return;
         }
         ...
         {
            this.var_1158 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_856,this._objectId,name);
