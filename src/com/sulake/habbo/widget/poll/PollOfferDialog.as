package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1465:String = "POLL_OFFER_STATE_OK";
      
      public static const const_687:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_525:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     this._state = const_1465;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_652,this._id));
                     break;
                  case "poll_offer_button_cancel":
                     this._state = const_687;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_524,this._id));
