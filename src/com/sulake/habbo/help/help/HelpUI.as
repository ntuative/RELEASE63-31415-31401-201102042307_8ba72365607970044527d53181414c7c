package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_340 = this._defaultViewId;
         this.var_477 = new Array();
         this.var_585 = new Array();
         super();
         this._component = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102042302));
         this.var_165 = param5;
         this.var_108 = new Map();
         this.var_108.add(HabboHelpViewEnum.const_1363,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_178,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_424,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_285,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_214,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_403,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_891,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_251,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_108.add(HabboHelpViewEnum.const_1192,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_108.add(HabboHelpViewEnum.const_967,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_662,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_108.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_108.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_477.length == 0 || param1 != this.var_340)
            {
               this.var_477.push(this.var_340);
            }
         }
         this.var_340 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_340);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_165.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_251:
               this.showUI(HabboHelpViewEnum.const_251);
               break;
            case CallForHelpResultEnum.const_1062:
               this.showUI(HabboHelpViewEnum.const_967);
               break;
            case CallForHelpResultEnum.const_1133:
               this.showUI(HabboHelpViewEnum.const_1192);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_108.getValue(HabboHelpViewEnum.const_178) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_494));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_108.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_108.getValue(this.var_340);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2342 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2344;
         this._window.width = _loc1_.width + this.var_2342;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_477.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_340 == HabboHelpViewEnum.const_178)
         {
            return;
         }
         if(this.var_585.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_585.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_585.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_339.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_585[1],this.var_585[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_585[0],this.var_585[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_340 == HabboHelpViewEnum.const_178 || this.var_477.length == 0)
         {
            return;
         }
         if(this.var_339 == null)
         {
            ...
            this.var_339 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_339.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_339.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_339 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_339 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_339 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
