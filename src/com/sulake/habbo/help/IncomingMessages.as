   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.method_1 != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_356)
            {
               this._component.userRegistry.registerUser(_loc5_.method_1,_loc5_.name);
            }
            if(_loc5_.method_1 == this._userId)
            {
               this.var_2029 = _loc5_.id;
            }
            _loc4_++;
         }
         this._component.tellUI(HabboHelpViewEnum.const_662);
      }
      ...
      {
         this._component.showUI(HabboHelpViewEnum.const_403);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this._component.tellUI(HabboHelpViewEnum.const_178);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_424);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this._component.tellUI(HabboHelpViewEnum.const_214,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_1096);
         this._component.tellUI(HabboHelpViewEnum.const_1096,_loc5_);
      }
