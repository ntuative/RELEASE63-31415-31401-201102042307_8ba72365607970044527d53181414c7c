package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      public function TutorialCallGuideBotView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_34.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_51,this.onShowMenuEvent);
      }
      ...
      {
         return TutorialUI.const_553;
      }
      
      public function dispose() : void
      {
         this.setToolbarIconHighlight(false);
         this.var_34.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_51,this.onShowMenuEvent);
      }
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_100,HabboToolbarIconEnum.HELP);
         if(param1)
         {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_649 = this.var_34.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_649.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_34.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP_ARROW,this.var_649));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_34.showView(TutorialUI.const_91);
               }
         }
      }
   }
