package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1264:uint = 13232628;
      
      private static var var_1538:uint = 11129827;
      ...
      private var var_1539:IWindowContainer;
      ...
      private var var_1012:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_374;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_444 = param1;
         if(this.var_1540 == this.var_444)
         {
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_40.width;
            this._window.content.height = this.var_40.height;
         }
      }
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1539 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_664)
         {
            this.var_664 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_664)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_665)
         {
            this.var_665 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_665)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_787:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_785:
            ...
            case ChangeUserNameResultMessageEvent.var_974:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_973:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_973 || param1 == ChangeUserNameResultMessageEvent.var_974)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1012 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1012.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1264;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1265)
         {
            if(param1.type == WindowEvent.const_102)
            {
