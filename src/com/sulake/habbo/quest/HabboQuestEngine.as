package com.sulake.habbo.quest
{
   ...
   import com.sulake.habbo.communication.messages.outgoing.quest.OpenQuestListForCampaignMessageEvent;
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine
   {
      ...
      public function method_4(param1:String) : void
      {
      ...
      private function onQuestsToolBarIconClick() : void
      {
         ...
         {
            _loc2_ = this.var_180.getKey("questing.supportMultipleCampaigns","");
            if(_loc2_ && _loc2_ == "true")
            {
      ...
      {
         this._communication.getHabboMainConnection(null).send(new OpenQuestListForCampaignMessageEvent(param1));
      }
