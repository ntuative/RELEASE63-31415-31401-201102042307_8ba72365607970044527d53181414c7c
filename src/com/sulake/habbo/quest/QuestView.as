package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1708:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_92.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1708 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_92)
         {
            this.var_62.controller.activateQuest(this.var_92);
         }
      }
      ...
      private function localize() : void
      {
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_62.code,this.var_92.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_62.code,"type_" + this.var_92.type.toLowerCase()].join(".");
         ...
         {
            _loc33_ = this.var_62.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_92.roomItemTypeName);
            if(_loc33_)
            {
               _loc34_ = this.var_62.controller.questEngine.roomEngine.getFurnitureImage(_loc33_.id,new Vector3d(90,0,0),64,this);
               this.var_1709 = _loc34_.id;
               if(_loc34_ && _loc34_.data)
               {
                  this.imageReady(_loc34_.id,_loc34_.data);
               }
               this.var_62.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc33_.title);
            }
         }
         ...
         {
            this.var_62.controller.questEngine.setImageFromAsset(_loc15_,this.var_92.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else
         {
            this.var_1709 = -1;
         ...
         this.var_62.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_92.rewardCurrencyAmount.toString());
         ...
         var _loc32_:String = "icon_" + this.var_62.code + "_reward_" + this.var_92.rewardCurrencyAmount;
