package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_499:Quest;
      
      private var var_295:QuestView;
      
      private var var_2509:Boolean = false;
      
      private var _window:IWindowContainer;
      
      private var var_1147:IWindowContainer;
      
      private var var_1388:IWindowContainer;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_179 = new QuestHelp(this);
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_741)
         {
            _loc1_.dispose();
         }
         this.var_741 = [];
      ...
      private function reset() : void
      {
         ...
         if(this.var_349)
         {
            ...
            {
               this.var_296.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_349 = null;
            this.var_296.destroyListItems();
            this.var_296.removeListItems();
         }
         this.var_499 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1147 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1388 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_296 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1388.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1388.findChildByName("currency.amount").caption = "${quest_" + this.var_1785 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_1148 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1148)
         {
            this.var_1148.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1148.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1148.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_499)
         {
            this.var_499.selected = false;
         }
         if(this.var_179)
         {
            this.var_1147.addChild(this.var_179.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1570);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1388.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_296.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_44 || _loc4_.status == QuestStatusEnum.const_461))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_296.maxScrollV > 0)
            {
               this.var_296.scrollV = _loc3_.view.y / this.var_296.maxScrollV;
            }
         }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_499 = param1;
         this.var_499.selected = true;
         this.showQuestData(this.var_499);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_295 = new QuestView(this,param1);
         this.var_1147.addChild(this.var_295.view);
         this.var_295.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_741.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_741)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_741.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_741.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc6_ = this.var_296.getListItemIndex(_loc2_.view);
            this.var_296.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_296.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_296.addListItem(_loc5_.view);
            }
            if(this.var_499 == _loc2_)
            {
