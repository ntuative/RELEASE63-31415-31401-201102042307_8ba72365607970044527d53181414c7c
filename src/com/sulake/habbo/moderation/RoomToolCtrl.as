package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_821:ICheckBoxWindow;
      
      private var var_1278:ICheckBoxWindow;
      
      private var var_1279:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_337));
         Logger.log("BEGINNING TO SHOW: " + this.var_337);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1511;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_337);
         if(param1.flatId != this.var_337)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_337);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1017 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1017);
         this.var_1017.procedure = this.onSelectTemplate;
         this.var_821 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1278 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1279 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(!param1.exists)
         {
            this.disposeItemFromList(this.var_54,_loc3_);
            this.disposeItemFromList(this.var_54,this.var_54.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_743,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_821.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1561,_loc2_,this.var_491.text,"",""));
         if(this.var_1278.isSelected || this.var_1279.isSelected || this.var_821.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1278.isSelected,this.var_1279.isSelected,this.var_821.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1600);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1609);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1017.selection];
         if(_loc3_ != null)
         {
            this.var_599 = false;
            this.var_491.text = _loc3_;
         }
      }
   }
}
