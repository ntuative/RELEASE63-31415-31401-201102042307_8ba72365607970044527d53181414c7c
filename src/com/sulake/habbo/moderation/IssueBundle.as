package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_673:IssueMessageData = null;
      
      private var var_672:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2156 = param2.pickerUserId;
         this.var_2157 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1034 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1035;
         }
         if(this.var_673 == null || param1.timeStamp < this.var_673.timeStamp)
         {
            this.var_673 = param1;
         }
         if(this.var_672 == null || param1.priority > this.var_672.timeStamp)
         {
            this.var_672 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1034 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1035;
            }
            if(this.var_673 == _loc2_)
            {
               this.var_673 = null;
            }
            if(this.var_672 == _loc2_)
            {
               this.var_672 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_672;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_673;
         if(_loc2_ == null)
         {
