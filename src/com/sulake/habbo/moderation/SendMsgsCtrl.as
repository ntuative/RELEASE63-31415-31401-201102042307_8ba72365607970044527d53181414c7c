package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         return WindowTracker.const_1457;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.messageTemplates[this.var_1017.selection];
         if(_loc3_ != null)
         {
            this.var_599 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModMessageMessageComposer(this.var_1375,this.var_491.text,this.var_1376));
         this.dispose();
      }
