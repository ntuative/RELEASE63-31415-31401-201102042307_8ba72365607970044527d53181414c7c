package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_838:Array = [];
      
      private static var var_1616:int = 1000;
      
      private static var var_837:Array = [];
      
      private static var var_1617:int = 200;
      ...
      private var var_1601:IMessageComposer;
      ...
      private var var_1618:Dictionary;
      ...
      {
         this.var_684 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_685 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_470 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1601);
      ...
      private function populateRoomChat(param1:RoomChatlogData) : void
      {
         ...
         this.addHeaderLineToList(_loc2_,this.var_54);
         var _loc4_:* = true;
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_838.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_685.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_838.length < var_1616)
         {
            ...
            param1.width = this.var_685.width;
            param1.height = this.var_685.height;
            var_838.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_837.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_684.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_837.length < var_1617)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_684.width;
            param1.height = this.var_684.height;
            var_837.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1618[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1316.getValue(param2.chatterName))
            {
               this.var_1316.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1316.getValue(_loc2_);
      ...
      {
         if(param1.type != WindowEvent.const_46 || param2 != this._frame)
         {
            return;
         }
         this.var_470.reset();
      ...
      private function refreshListDims() : void
      {
         ...
         var _loc2_:* = null;
         this.var_54.autoArrangeItems = false;
         var _loc3_:int = this.var_54.numListItems;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc1_ = IWindowContainer(this.var_54.getListItemAt(_loc4_));
