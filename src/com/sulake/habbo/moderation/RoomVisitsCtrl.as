package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_875:Array = [];
      
      private static var var_1669:int = 200;
      ...
      private var var_706:IWindowContainer;
      ...
      {
         this.var_706 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1518;
      }
      ...
      private function populate() : void
      {
         var _loc2_:* = null;
         var _loc1_:* = true;
         for each(_loc2_ in this.var_105)
         {
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         _loc7_.color = _loc4_;
         this.addRoomRowToList(_loc3_,this.var_54);
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_875.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_706.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_875.length < var_1669)
         {
            ...
            param1.width = this.var_706.width;
            param1.height = this.var_706.height;
            var_875.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1344)
         {
