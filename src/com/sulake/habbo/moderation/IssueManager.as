package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1159:String = "issue_bundle_open";
      
      public static const const_642:String = "issue_bundle_my";
      
      public static const const_1024:String = "issue_bundle_picked";
      
      public static const const_1426:int = 15000;
       
      
      private var var_63:ModerationManager;
      
      private var var_628:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_628 = new IssueBrowser(this,this.var_63.windowManager,this.var_63.assets);
         this.var_1180 = [];
         this.var_1181 = [];
         this.var_956 = new Map();
         this.var_2639 = parseInt(this.var_63.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1863 = new Timer(const_1426,0);
         this.var_1863.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1863.start();
      }
      ...
      {
         var _loc4_:IssueBundle = this.var_98.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
         this.sendPick(_loc4_.getIssueIds(),param2,param3);
         this.var_1180 = this.var_1180.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_98.getValues();
      ...
      public function releaseAll() : void
      {
         ...
         var _loc1_:int = this.var_63.sessionDataManager.userId;
         var _loc2_:* = [];
         for each(_loc3_ in this.var_98)
         {
            if(_loc3_.state == IssueMessageData.const_383 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_98.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(param1 == null || param1.length == 0 || this.var_63 == null || this.var_63.connection == null)
         {
            return;
         }
         this.var_63.connection.send(new ReleaseIssuesMessageComposer(param1));
         this.var_1181 = this.var_1181.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_628 == null || !this.var_628.isOpen())
         {
            this.var_63.soundManager.playSound(HabboSoundTypesEnum.const_1004);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_955.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_98.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     this.var_98.remove(_loc3_.id);
                     this.removeHandler(_loc3_.id);
                  }
                  this.var_955.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1505)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_98)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_955.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2638++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_955.add(param1.issueId,_loc2_);
            this.var_98.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(this.var_1180.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_63.sessionDataManager.userId;
            if(_loc5_ != param1.pickerUserId)
            {
               if(param1.state == IssueMessageData.const_383)
               {
         ...
         {
            _loc6_ = this.getBundles(const_642);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1181.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_63 == null || this.var_63.configuration == null)
         {
            return;
         }
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2639);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_956.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_956.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_955.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_98.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         var _loc2_:* = [];
         var _loc3_:int = this.var_63.sessionDataManager.userId;
         for each(_loc4_ in this.var_98)
         {
            switch(param1)
            {
               case const_1159:
                  ...
                  break;
               case const_642:
                  if(_loc4_.state == IssueMessageData.const_383 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = new IssueHandler(this.var_63,_loc2_);
         this.removeHandler(param1);
         this.var_956.add(param1,_loc3_);
         this.var_63.windowTracker.show(_loc3_,null,false,false,false);
         this.var_1180 = [];
      }
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_956.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_98.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         if(param1 == null || this.var_63 == null || this.var_63.connection == null)
         {
            return;
         }
         this.var_63.connection.send(new CloseIssuesMessageComposer(param1,param2));
      }
      ...
      private function sendPick(param1:Array, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_63.connection.send(new PickIssuesMessageComposer(param1,param2,param3));
      }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_98.getValues();
         var _loc4_:int = this.var_63.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_383 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_98)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_956.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
