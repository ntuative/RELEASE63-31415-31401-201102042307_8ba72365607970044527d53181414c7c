package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1969:String = "my_issues";
      
      private const const_1970:String = "open_issues";
      
      private const const_1971:String = "picked_issues";
      
      private const const_1986:String = "closed_issues";
      ...
      private var var_1740:IIssueBrowserView;
      
      private var var_1741:IIssueBrowserView;
      
      private var var_1739:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_249 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_249.numTabItems)
            {
               _loc5_ = this.var_249.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_56,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_249 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_249 == null || this.var_249.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_249.selector.getSelectableByName("open_issues");
         this.var_249.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_345 == _loc2_)
         {
            return;
         }
         ...
         this.var_345.view.width = this.var_249.container.width;
         this.var_345.view.height = this.var_249.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1969:
               ...
               {
                  this.var_1740 = new MyIssuesView(this.issueManager,this,this.var_249.container);
               }
               return this.var_1740;
            case this.const_1970:
               if(this.var_1741 == null)
               {
                  this.var_1741 = new OpenIssuesView(this.issueManager,this,this.var_249.container);
               }
               return this.var_1741;
            case this.const_1971:
               if(this.var_1739 == null)
               {
                  this.var_1739 = new PickedIssuesView(this.issueManager,this,this.var_249.container);
               }
