package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private static const const_586:int = 20;
      ...
      private var var_1614:IWindowContainer;
      
      private var var_2791:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1614 = this.var_628.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         var _loc4_:int = this.var_54.numListItems;
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1614.clone() as IWindowContainer;
         ...
         else if(_loc4_ > _loc5_)
         {
            ...
            {
               _loc9_ = this.var_54.removeListItemAt(0);
               _loc9_.dispose();
               _loc2_++;
            }
         }
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1614 == null)
            {
               return;
            }
            _loc3_ = this.var_54.getListItemAt(_loc2_ - 1) as IWindowContainer;
            if(_loc3_ == null)
            {
               return;
            }
            _loc3_.width = this.var_54.width;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_628.assets.getAssetByName(_loc12_) as BitmapDataAsset;
