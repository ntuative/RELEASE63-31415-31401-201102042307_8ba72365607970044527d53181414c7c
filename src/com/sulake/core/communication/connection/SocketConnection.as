package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1515:int = 10000;
      ...
      private var var_462:ByteArray;
      
      private var var_1069:IEncryption;
      
      private var var_694:IProtocol;
      
      private var _id:String;
      
      private var var_1068:IMessageClassManager;
      
      private var var_281:ICoreCommunicationManager;
      
      private var var_463:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_281 = param2;
         this.var_462 = new ByteArray();
         this.var_1068 = new MessageClassManager();
         this.var_74 = new Socket();
         this.var_331 = new Timer(const_1515,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_463)
         {
            this.var_463.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_331.start();
         this.var_693 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1068.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_694.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_463)
         {
            this.var_463.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1069 != null)
         {
            _loc3_ = this.var_1069.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1068.method_10(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_694.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_694.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1069 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_694.getMessages(this.var_462,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_463)
               {
                  this.var_463.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1068.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_462,offset);
               this.var_462 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_462.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_462.writeByte(this.var_74.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_331.stop();
         this.var_1625 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_693));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1625 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_693));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_693));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_693));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_693));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_693));
