package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_644:Number;
      
      protected var var_645:Number;
      
      protected var var_101:Number;
      
      protected var var_91:Number;
      
      protected var _container:IWindowContainer;
      
      protected var var_1976:Boolean = false;
      ...
      protected var var_980:Boolean = true;
      
      protected var var_436:Boolean = false;
      
      protected var var_1227:Boolean = false;
      
      protected var var_1977:int = 0;
      
      protected var var_1975:int = 0;
      
      protected var var_1228:Number;
      
      protected var var_1229:Number;
      
      protected var var_1230:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_101 = 0;
         this.var_91 = 0;
         this._horizontal = param2 == WindowType.const_385;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_161 = var_433 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_382,WindowStyle.const_637,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_46,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_575,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_290,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_430,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1227;
      }
      ...
      {
         var _loc1_:int = this.var_101 - width;
      ...
      {
         return new Rectangle(this.var_644 * this.maxScrollH,this.var_645 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_644)
         {
            this.var_644 = param1;
            this._container.x = -this.var_644 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_66);
            dispatchEvent(new WindowEvent(WindowEvent.const_442,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         if(param1 != this.var_645)
         {
            this.var_645 = param1;
            this._container.y = -this.var_645 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_66);
            dispatchEvent(new WindowEvent(WindowEvent.const_442,this,null));
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_46,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_575,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_290,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_430,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         if(this._horizontal)
         {
            param1.x = this.var_101 + (this.numListItems > 0 ? this._spacing : 0);
            this.var_101 = param1.rectangle.right;
            this._container.width = this.var_101;
         }
         else
         {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_41:
               this.var_1977 = _loc3_;
               this.var_1975 = _loc4_;
               this.var_1228 = 0;
               this.var_1229 = 0;
               this.var_1230 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_193:
               if(this.var_1230)
               {
                  this.var_1228 = this.var_1977 - _loc3_;
                  this.var_1229 = this.var_1975 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1228 != 0 && this.var_101 != 0)
                     {
                        this.scrollH += this.var_1228 / this.var_101;
                     }
                  }
                  else if(this.var_1229 != 0 && this.var_91 != 0)
                  {
                     this.scrollV += this.var_1229 / this.var_91;
                  }
                  this.var_1977 = _loc3_;
                  this.var_1975 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_195:
               if(this.var_1230)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1228,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1229);
                  }
                  this.var_1230 = false;
                  _loc2_ = true;
               }
      ...
      private function scrollAnimationCallback(param1:int, param2:int) : void
      {
         if(!disposed)
         {
            this.scrollH -= param1 / this.var_101;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_980 && !this.var_527 && this._container)
         {
            this.var_527 = true;
            ...
            if(this._horizontal)
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     _loc2_.x = this.var_101;
                     this.var_101 += _loc2_.width + this._spacing;
                     if(this.var_436)
                     {
               ...
               if(_loc1_ > 0)
               {
                  this.var_101 -= this._spacing;
               }
            }
            else
            {
               this.var_101 = var_11.width;
               this.var_91 = 0;
               _loc4_ = 0;
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(this.var_436)
                     {
                        ...
                        this.var_101 = _loc3_ > this.var_101 ? Number(_loc3_) : Number(this.var_101);
                     }
                  }
                  _loc4_++;
               }
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_849)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_381,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1174);
         }
         if(this.var_980 != PropertyDefaults.const_1017)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_649,this.var_980,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1424);
         }
         if(this.var_436 != PropertyDefaults.const_998)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_828,this.var_436,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1641);
         }
         if(this.var_1227 != PropertyDefaults.const_994)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_760,this.var_1227,PropertyStruct.const_36,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_760:
                  ...
                  break;
               case PropertyDefaults.const_649:
                  this.var_980 = _loc2_.value as Boolean;
                  break;
            }
         }
