package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1209:String = "_TITLE";
      
      private static const const_1248:String = "_HEADER";
      
      private static const const_1247:String = "_CONTENT";
      
      private static const const_1246:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1323:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1209) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1323 = findChildByTag(const_1248) as IHeaderWindow;
            if(!this.var_1323)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_177 = findChildByTag(const_1247) as IWindowContainer;
            if(!this.var_177)
            {
      ...
      {
         return findChildByTag(const_1246) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1203,_loc2_,false);
      ...
      {
         return this.content != null && this.var_977 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_291);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_209);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_217);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_294,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_230,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_206,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_215,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
