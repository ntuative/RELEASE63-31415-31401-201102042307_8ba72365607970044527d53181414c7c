package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1346:String = "_SELECTOR";
      
      private static const const_1347:String = "_CONTENT";
       
      
      protected var var_984:ITabSelectorWindow;
      
      protected var var_1985:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_984 = findChildByTag(const_1346) as ITabSelectorWindow;
            if(this.var_984 != null)
            {
               this.var_984.procedure = this.selectorEventProc;
            }
         }
         return this.var_984;
      }
      ...
      {
         if(this.var_1985 == null)
         {
            this.var_1985 = findChildByTag(const_1347) as IWindowContainer;
         }
      ...
      {
         return !!this.var_777 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_984.numSelectables;
      }
