package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_406:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_574:int = -1;
      
      private var var_857:Boolean = false;
      
      private var var_173:DropMenuController;
      ...
      {
         if(param1 > this.var_241.lenght - 1)
         {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_574 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_380,this,null));
         }
      }
      ...
      {
         if(this.var_173 != null && !this.var_173.disposed)
         {
            this.var_173.destroy();
            this.var_173 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_406) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_173 == null || this.var_173.disposed)
         {
            this.var_173 = context.create(name + "::submenu","",WindowType.const_466,var_80,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_173.setGlobalRectangle(_loc1_);
         }
         this.var_173.activate();
         return this.var_173;
      }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_241.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_857 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_173.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_857)
         {
            if(this.open())
            {
               if(this.var_241.length)
               {
                  this.populateMenuItemContainer(this.var_241,this.getSubMenu(),this.subMenuEventProc);
                  this.var_857 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_857 = false;
            this.getTitleLabel().text = this.var_574 < this.var_241.length && this.var_574 > -1 ? this.var_241[this.var_574] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_455,var_80,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_382,var_80,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_574 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_574).setStateFlag(WindowState.const_50,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_492)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1164:
            case WindowMouseEvent.const_58:
               ...
               break;
            case WindowTouchEvent.const_842:
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowEvent.const_708:
               if(param2 == this.var_173)
               {
                  this.closeMenuView();
               }
         }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1178,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1089;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_241[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_241.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_635,this.var_241,PropertyStruct.const_127,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1485);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_635)
            {
