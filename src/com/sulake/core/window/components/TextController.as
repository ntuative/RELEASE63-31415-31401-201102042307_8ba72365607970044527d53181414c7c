package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1204:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_793:Number;
      ...
      protected var var_118:Boolean = false;
      
      protected var var_976:Boolean = false;
      
      private var var_404:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_404,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_404 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_404,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_166);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_609 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_404);
      }
      ...
      {
         this.var_793 = param1;
         this._field.scrollH = this.var_793 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_793 * this.maxScrollH,this.var_525 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_404);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1111) ? new PropertyStruct(PropertyDefaults.const_655,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1053) : PropertyDefaults.const_1483);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1191 ? new PropertyStruct(PropertyDefaults.const_783,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_997) : PropertyDefaults.const_1383);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_36,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_128,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_259,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1175 ? new PropertyStruct(PropertyDefaults.const_1109,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1114) : PropertyDefaults.const_1378);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_855) ? new PropertyStruct(PropertyDefaults.const_400,this._field.textColor,PropertyStruct.const_128,true) : PropertyDefaults.const_1187);
         _loc1_.push(this.var_404 != TextStyleManager.const_166 ? new PropertyStruct(PropertyDefaults.const_333,this.var_404,PropertyStruct.const_52,true,PropertyDefaults.const_788) : PropertyDefaults.const_1077);
         _loc1_.push(this.var_37.left != PropertyDefaults.const_835 ? new PropertyStruct(PropertyDefaults.const_230,this.var_37.left,PropertyStruct.const_38,true) : PropertyDefaults.const_452);
         _loc1_.push(this.var_37.top != PropertyDefaults.const_756 ? new PropertyStruct(PropertyDefaults.const_206,this.var_37.top,PropertyStruct.const_38,true) : PropertyDefaults.const_429);
         _loc1_.push(this.var_37.right != PropertyDefaults.const_686 ? new PropertyStruct(PropertyDefaults.const_260,this.var_37.right,PropertyStruct.const_38,true) : PropertyDefaults.const_482);
         _loc1_.push(this.var_37.bottom != PropertyDefaults.const_651 ? new PropertyStruct(PropertyDefaults.const_215,this.var_37.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_432);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_969 ? new PropertyStruct(PropertyDefaults.const_848,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1396);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_269,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_269,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_269,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
