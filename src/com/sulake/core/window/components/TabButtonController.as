package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1687:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1301:String = "TAB_BUTTON_TITLE";
      
      private static const const_1688:String = "TAB_BUTTON_ICON";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = findChildByTag(const_1301);
         if(_loc2_ != null)
         {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_273)
         {
