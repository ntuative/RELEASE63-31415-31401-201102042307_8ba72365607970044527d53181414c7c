package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1226:Boolean = false;
      
      protected var var_777:Boolean = false;
      ...
      {
         this.var_1223 = param1 == null ? "" : param1;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_492)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_777 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_384,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_840,false,PropertyStruct.const_36,true) : PropertyDefaults.const_1487);
         _loc1_.push(this.var_1226 != PropertyDefaults.const_1061 ? new PropertyStruct(PropertyDefaults.const_750,this.var_1226,PropertyStruct.const_36,true) : PropertyDefaults.const_1581);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1118 ? new PropertyStruct(PropertyDefaults.const_696,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_1418);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1140 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1491);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_750:
                  this.var_1226 = _loc2_.value as Boolean;
                  if(this.var_1226)
                  {
