package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_314:Object = null;
      ...
      {
         return this.var_314 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_404);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_314 != null)
            {
               _loc1_.textColor = uint(this.var_314);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_404 != param1.name)
         {
            this.var_404 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2054 = _loc2_.textWidth;
         this.var_2053 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_314 != _loc2_.color : this.var_314 != null && this.var_314 != PropertyDefaults.const_855) ? new PropertyStruct(PropertyDefaults.const_400,this.var_314,PropertyStruct.const_128,true) : PropertyDefaults.const_1187);
         if(this.var_37)
         {
            if(this.var_37.left != PropertyDefaults.const_835)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_230,this.var_37.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_452);
            }
            if(this.var_37.top != PropertyDefaults.const_756)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_206,this.var_37.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_429);
            }
            if(this.var_37.right != PropertyDefaults.const_686)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,this.var_37.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_482);
            }
            if(this.var_37.bottom != PropertyDefaults.const_651)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_215,this.var_37.bottom,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_432);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_400:
                  this.var_314 = _loc2_.value as uint;
                  break;
               case PropertyDefaults.const_230:
                  ...
                  break;
               case PropertyDefaults.const_206:
                  if(this.var_37 || _loc2_.valid)
                  {
