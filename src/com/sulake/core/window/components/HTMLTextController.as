package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_949:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_756:String;
      
      private var var_1176:String = null;
      
      private var var_1853:StyleSheet = null;
      ...
      {
         this.var_756 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1176 == param2)
         {
            return;
         }
         param1.var_1176 = param2;
         param1.var_1853 = null;
         if(param1.var_1176 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1176);
            param1.var_1853 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_834.indexOf(param1) > -1)
         {
            this.var_756 = param1;
         }
      }
      ...
      {
         return this.var_756 == LinkTarget.const_31 ? defaultLinkTarget : this.var_756;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1853;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_756 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_805,this.var_756,PropertyStruct.const_52,true,PropertyDefaults.const_834));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1412);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_805)
            {
               this.var_756 = _loc2_.value as String;
               break;
            }
