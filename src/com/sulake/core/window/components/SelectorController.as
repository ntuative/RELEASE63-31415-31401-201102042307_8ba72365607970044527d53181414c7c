package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_196:ISelectableWindow;
      
      protected var var_1982:Boolean = true;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_213)
         {
      ...
      {
         return this.var_196 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         if(param1 != null)
         {
            if(param1 != this.var_196)
            {
               if(this.var_196 != null)
               {
                  this.var_196.unselect();
               }
               this.var_196 = param1;
               this.var_196.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_380,this,this.var_196));
               }
            }
         }
      }
