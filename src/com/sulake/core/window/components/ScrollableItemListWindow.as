package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_428:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_78))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_428)
         {
            this.var_428.removeEventListener(WindowEvent.const_297,this.scrollBarEventProc);
            this.var_428.removeEventListener(WindowEvent.const_240,this.scrollBarEventProc);
            this.var_428 = null;
         }
         if(this.var_1203)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1203)
         {
            this.var_1203 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_428)
         {
            this.var_428 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_428)
            {
               this.var_428.addEventListener(WindowEvent.const_297,this.scrollBarEventProc);
               this.var_428.addEventListener(WindowEvent.const_240,this.scrollBarEventProc);
            }
         }
         return this.var_428;
      }
