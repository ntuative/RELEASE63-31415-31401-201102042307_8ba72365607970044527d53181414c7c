package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_372:Rectangle;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this.var_16 = null;
            this._state = WindowState.const_484;
            this.var_791 = null;
         }
      }
      ...
      {
         return this.var_372.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_372.height;
      }
