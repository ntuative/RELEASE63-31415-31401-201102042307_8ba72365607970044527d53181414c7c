package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_972:String = "_EXCLUDE";
      
      public static const const_1873:String = "_INCLUDE";
      
      public static const const_1758:String = "_TEMP";
      
      private static const const_1325:String = "layout";
      
      private static const const_946:String = "window";
      
      private static const const_947:String = "variables";
      
      private static const const_948:String = "filters";
      
      private static const const_599:String = "name";
      
      private static const const_1320:String = "style";
      
      private static const const_598:String = "params";
      
      private static const const_1319:String = "tags";
      ...
      private static const const_1332:String = "visible";
      
      private static const const_1316:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_962:String = "blend";
      
      private static const const_1321:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1326:String = "treshold";
      
      private static const const_1317:String = "children";
      
      private static const const_1329:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1322:String = "height_min";
      
      private static const const_1331:String = "height_max";
      
      private static const const_600:String = "true";
      
      private static const const_160:String = "0";
      
      private static const const_1327:String = "$";
      
      private static const const_1328:String = ",";
      
      private static const const_48:String = "";
      
      private static const const_1318:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1324:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1233:Dictionary;
      
      protected var var_1232:Dictionary;
      
      protected var var_983:Dictionary;
      
      protected var var_1481:Dictionary;
      
      protected var var_1980:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1232 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1233,this.var_1232);
         this.var_983 = new Dictionary();
         this.var_1481 = new Dictionary();
         ParamCodeTable.fillTables(this.var_983,this.var_1481);
         this.var_1980 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1324,const_48);
         return param1.replace(const_1318,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1233)
            {
               delete this.var_1233[_loc1_];
            }
            for(_loc1_ in this.var_1232)
            {
               delete this.var_1232[_loc1_];
            }
            for(_loc1_ in this.var_983)
            {
               delete this.var_983[_loc1_];
            }
            for(_loc1_ in this.var_1481)
            {
               delete this.var_1481[_loc1_];
            }
            this.var_1980.dispose();
            this.var_1980 = null;
            this.var_16 = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1325)
         {
            _loc8_ = param1.child(const_947);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_948).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1233[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_599,variables,"")));
         style = uint(this.parseAttribute(xml,const_1320,variables,style));
         params = uint(this.parseAttribute(xml,const_598,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1319,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_160));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_160));
         rect.width = Number(this.parseAttribute(xml,const_1323,variables,const_160));
         rect.height = Number(this.parseAttribute(xml,const_1330,variables,const_160));
         visible = this.parseAttribute(xml,const_1332,variables,visible.toString()) == const_600;
         caption = unescape(String(this.parseAttribute(xml,const_1316,variables,caption)));
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_598).length() > 0)
         {
            list = xml.child(const_598).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_599,variables,"") as String;
               if(this.var_983[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_599)) + "\"!");
               }
               params |= this.var_983[param];
               i++;
            }
         }
         if(tag != const_48)
         {
            tags = tag.split(const_1328);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this.var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_947)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1329,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1322,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1331,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_600;
         blend = Number(this.parseAttribute(xml,const_962,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1321,variables,window.clipping.toString()) == const_600;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1326,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_948).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_191)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1232[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_972) == -1)
                  {
