package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2744 = param3 == const_246 || param3 == const_127 || param3 == const_268 || param3 == const_221;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_246:
               ...
               _loc1_ = "<var key=\"" + this.var_534 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_221:
               ...
               break;
            case const_128:
               _loc1_ = "<var key=\"" + this.var_534 + "\" value=\"" + "0x" + uint(this.var_164).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_534 + "\" value=\"" + this.var_164 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
