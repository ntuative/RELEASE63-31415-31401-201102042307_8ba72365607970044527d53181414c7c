package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_166:String = "regular";
      ...
      private static var var_454:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_583:String = "{";
      
      private static const const_584:String = "}";
      
      private static const const_1234:String = "/*";
      
      private static const const_1233:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_166],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_166] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_454.indexOf(_loc4_.name) == -1)
            {
               var_454.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_584);
         if(countSubStrings(param1,const_583) != countSubStrings(param1,const_584))
         {
            throw new Error("Mismatching amount of \"" + const_583 + "\" versus \"" + const_584 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1234) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1233) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_583)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
