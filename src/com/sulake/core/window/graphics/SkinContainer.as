package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_928:uint = 8;
      
      private static const const_1284:String = "skin";
      
      private static const const_1282:String = "bitmap";
      
      private static const const_1286:String = "fill";
      
      private static const const_1285:String = "text";
      
      private static const const_1283:String = "label";
      
      private static const const_1287:String = "shape";
      ...
      private var var_1716:Dictionary;
      
      private var var_2419:Dictionary;
      
      private var var_2420:Dictionary;
      
      private var var_2418:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1716 = new Dictionary();
         this.var_2419 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1716,this.var_2419);
         this.var_2420 = new Dictionary();
         this.var_2418 = new Dictionary();
         StateCodeTable.fillTables(this.var_2420,this.var_2418);
         this.var_403 = new Dictionary();
         this.var_403[const_1284] = BitmapSkinRenderer;
         this.var_403[const_1282] = BitmapDataRenderer;
         this.var_403[const_1286] = FillSkinRenderer;
         this.var_403[const_1285] = TextSkinRenderer;
         this.var_403[const_1283] = LabelRenderer;
         this.var_403[const_1287] = ShapeSkinRenderer;
         this.var_403[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_403[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_311 == null)
         {
            var_311 = new Array();
            var_311.push(WindowState.const_68);
            var_311.push(WindowState.const_78);
            var_311.push(WindowState.const_85);
            var_311.push(WindowState.const_50);
            var_311.push(WindowState.const_90);
            var_311.push(WindowState.const_83);
            var_311.push(WindowState.const_105);
            var_311.push(WindowState.const_98);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2720 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1716[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_896[param1] == null)
         {
            this.var_896[param1] = new Array(const_928);
         }
         this.var_896[param1][param2] = param3;
         if(this.var_897[param1] == null)
         {
            this.var_897[param1] = new Array(const_928);
         }
         this.var_897[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_896[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_192)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_897[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_192)
