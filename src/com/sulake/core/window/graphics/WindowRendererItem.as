package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_949:uint = 1;
      
      private static const const_950:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_961 = 0;
         this.var_1886 = new ColorTransform();
         this.var_979 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_950) : uint(const_601);
         var _loc6_:Boolean = this.var_182.width > 0 && this.var_182.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_961))
            {
               _loc5_ = const_949;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_949)
               {
                  ...
                  if(this.var_634)
                  {
                     ...
                     _loc7_.draw(param1,this.var_99,this.var_99.rect,this.var_961,false);
                  ...
                  {
                     this.var_979.tx = param2.x;
                     this.var_979.ty = param2.y;
                     this.var_1886.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_99,this.var_979,this.var_1886,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_850.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_192)
            {
               _loc2_ = this.var_850.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_192);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_850.getTheActualState(param1.type,param1.style,param1.state) != this.var_1449;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            case WindowRedrawFlag.const_66:
               this.var_634 = true;
               _loc4_ = true;
               break;
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_448:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_1190:
               this.var_961 = this.var_850.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_961 != this.var_1449)
               {
                  this.var_634 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_962:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_634 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1093:
               _loc4_ = true;
         }
         if(_loc4_)
         {
