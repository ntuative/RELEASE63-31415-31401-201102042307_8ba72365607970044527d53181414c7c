package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1241:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1240:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_139:IProfiler;
      ...
      {
         super();
         this.var_24 = param1 as ICore;
         this.var_2743 = new Array();
         this.var_139 = this.profiler;
         this._windowManager = param2;
         this.var_851 = param3;
         var _loc4_:ByteArray = new var_1241() as ByteArray;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(value != this.visible)
         {
            ...
            if(value)
            {
               ...
               this.var_24.setProfilerMode(true);
               this.var_24.queueInterface(new IIDProfiler(),function(param1:IID, param2:IUnknown):void
               {
            ...
            {
               this.var_24.setProfilerMode(false);
            }
         }
      }
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_139)
         {
            this.var_139.removeStopEventListener(this.refresh);
            this.var_139 = null;
         }
         if(!this.var_139 && param1)
         {
            this.var_139 = param1;
            this.var_139.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_815)
            {
               this.var_1488 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_139.getProfilerAgentsInArray();
         ...
         if(this.var_1488)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_139.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_139.numBitmapAssetInstances + " / " + this.var_139.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_851.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_139.numTrackedBitmapDataInstances + " / " + this.var_139.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1240() as ByteArray;
