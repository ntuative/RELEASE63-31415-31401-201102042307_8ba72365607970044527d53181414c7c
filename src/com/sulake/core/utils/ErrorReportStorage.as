package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1013:Map = new Map();
      
      private static var var_667:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_667.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_667.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_667.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_1013[param1] = param2;
      }
      
      public static function getParameter(param1:String) : String
      {
         return var_1013[param1];
      }
      
      public static function getParameterNames() : Array
      {
         return var_1013.getKeys();
      }
   }
}
