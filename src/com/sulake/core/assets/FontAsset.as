package com.sulake.core.assets
{
   ...
   public class FontAsset implements IAsset
   {
      ...
      protected var var_1521:AssetTypeDeclaration;
      
      protected var var_177:Font;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         try
         {
            if(unknown is Class)
            {
               this.var_177 = Font(FontEnum.registerFont(unknown as Class));
            }
         }
         catch(e:Error)
         {
      ...
      public function setFromOtherAsset(param1:IAsset) : void
      {
         ...
         {
            this.var_177 = FontAsset(param1).var_177;
            return;
         }
