package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_529:Array;
      
      protected var var_982:LoaderContext;
      
      protected var var_438:AssetLibrary;
      
      protected var var_757:XML;
      
      protected var _name:String;
      
      private var var_530:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_982 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_438 = new AssetLibrary("lib-" + this.var_530++);
         this.var_29.push(this.var_438);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_982;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_530++);
         this.var_529.push(_loc3_);
      ...
      {
         return this.var_438.loadFromResource(param1,param2);
      }
      
      public function unload() : void
      {
         while(this.var_529.length > 0)
         {
            (this.var_529.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_529.length)
            {
               _loc3_ = this.var_529[_loc4_] as IAssetLibrary;
      ...
      {
         return this.var_438.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_438.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_438.createAsset(param1,param2);
      }
      ...
      {
         return this.var_438.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_438.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_438.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_438.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_29.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
