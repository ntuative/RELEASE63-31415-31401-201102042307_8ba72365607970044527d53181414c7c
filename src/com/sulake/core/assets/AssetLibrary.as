package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1026:String = "AssetLibraryReady";
      
      public static const const_797:String = "AssetLibraryLoaded";
      
      public static const const_1617:String = "AssetLibraryUnloaded";
      
      public static const const_1476:String = "AssetLibraryLoadError";
      
      private static var var_302:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_508:uint = 0;
      
      private static var var_952:Array = new Array();
      ...
      private var var_423:Dictionary;
      
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_757 = new XML();
         this.var_422 = 0;
         this.var_424 = new Array();
         if(var_302 == null)
         {
            var_302 = new Dictionary(false);
         ...
         ++var_508;
         this.var_423 = new Dictionary(false);
         this.var_509 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_952.splice(var_952.indexOf(this),1);
            --var_508;
            this.var_509 = null;
            this.var_953 = null;
            this.var_159 = null;
      ...
      {
         if(this._file == param1.url && this.var_950)
         {
            if(!this.var_951 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_757,this.var_623);
            }
            this.var_951 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1026));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_509)
         {
            _loc2_ = this.var_509[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_509[_loc1_];
         }
         ...
         this.var_950 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1617));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_953[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_509[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1129,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1182,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_978,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1083,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_509[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_509[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_422;
                     this.var_424.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_509[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_424.length ? this.getAssetByName(this.var_424[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_159)
         {
            ...
            {
               return this.var_424.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_159[param1] != null || (this.var_623 != null ? this.var_623[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_302.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_302[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_423.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_423[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_302[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_423[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_302)
            {
               _loc3_ = AssetTypeDeclaration(var_302[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_423)
         {
            _loc3_ = AssetTypeDeclaration(this.var_423[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_302)
            {
               _loc4_ = AssetTypeDeclaration(var_302[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_423)
         {
            _loc4_ = AssetTypeDeclaration(this.var_423[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_757 = _loc2_.manifest.copy();
         ...
         this.var_950 = true;
         dispatchEvent(new Event(AssetLibrary.const_797));
         dispatchEvent(new Event(AssetLibrary.const_1026));
         if(this.var_951)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1476));
         this.var_39 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_757.child("library");
         if(_loc2_ == null)
         {
