package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private var var_323:IAssetLibrary;
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_239)
            {
               _loc3_ = this.var_239[_loc1_];
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function defineAssets(param1:XMLList) : void
      {
         ...
         while(_loc2_ < param1.length())
         {
            ...
            if(_loc3_.length() > 0)
            {
               ...
               _loc11_ = this.var_323.getAssetByName(_loc5_);
      ...
      private function definePalettes(param1:XMLList) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            if(XMLValidator.checkRequiredAttributes(_loc3_,_loc2_))
            {
               ...
               if(this.var_239[_loc4_] == null)
               {
                  _loc6_ = this.var_323.getAssetByName(_loc5_);
      ...
      {
         var _loc9_:GraphicAsset = this._assets[param1];
         if(_loc9_ != null)
         {
            _loc9_.dispose();
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            _loc6_ = new BitmapDataAsset(this.var_323.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_323.setAsset(param1,_loc6_);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:BitmapDataAsset = this.getLibraryAsset(param1);
         if(_loc2_ != null)
         {
            this.var_323.removeAsset(_loc2_);
            _loc2_.dispose();
      ...
      {
         return this.var_323.getAssetByName(param1) as BitmapDataAsset;
      }
      ...
      private function addLibraryAsset(param1:String, param2:BitmapData) : BitmapDataAsset
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = new BitmapDataAsset(this.var_323.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_323.setAsset(param1,_loc3_);
