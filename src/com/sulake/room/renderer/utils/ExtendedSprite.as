package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1765 || param2 != this.var_1764)
         {
      ...
      {
         if(this.var_1385 > 255 || bitmapData == null)
         {
            return false;
         }
