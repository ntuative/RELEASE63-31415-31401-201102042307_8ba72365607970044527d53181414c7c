package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_616:Number = 64;
      
      public static const const_1121:Number = 32;
      ...
      private var var_2761:Number = -500.0;
      
      private var var_2760:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1722 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_170.x,this.var_170.y,this.var_170.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_76.x * this.var_407,this.var_76.y * this.var_405,this.var_76.z * this.var_406);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_248.x,this.var_248.y,this.var_248.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_407 != param1 * this.var_1720)
         {
            this.var_407 = param1 * this.var_1720;
            ++this.var_155;
         }
      }
      ...
      {
         if(this.var_405 != param1 * this.var_1721)
         {
            this.var_405 = param1 * this.var_1721;
            ++this.var_155;
         }
      }
      ...
      {
         if(this.var_406 != param1 * this.var_1722)
         {
            this.var_406 = param1 * this.var_1722;
            ++this.var_155;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_76.x /= this.var_407;
         this.var_76.y /= this.var_405;
         this.var_76.z /= this.var_406;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_248.x;
         var _loc3_:Number = this.var_248.y;
         var _loc4_:Number = this.var_248.z;
         this.var_248.assign(param1);
         if(this.var_248.x != _loc2_ || this.var_248.y != _loc3_ || this.var_248.z != _loc4_)
         {
            ++this.var_155;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_171.assign(_loc24_);
            this.var_170.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_171.assign(_loc19_);
            this.var_170.assign(_loc20_);
         }
      }
      ...
      public function adjustLocation(param1:IVector3d, param2:Number) : void
      {
         ...
         var _loc3_:Vector3d = Vector3d.product(this.var_170,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_171);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_170);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_407;
         _loc2_.y *= this.var_405;
         _loc2_.z *= this.var_406;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1130);
         if(_loc3_ < this.var_2761 || _loc3_ > this.var_2760)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_171);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_171,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_76.x * this.var_407,this.var_76.y * this.var_405,this.var_76.z * this.var_406);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_170;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_407,param2.y * this.var_405,param2.z * this.var_406);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_407,param3.y * this.var_405,param3.z * this.var_406);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_407,param4.y * this.var_405,param4.z * this.var_406);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1121;
         }
         else
         {
            this.scale = const_616;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_616;
      }
