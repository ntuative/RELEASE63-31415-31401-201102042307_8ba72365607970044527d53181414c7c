package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_171 * this.var_171 + this.var_170 * this.var_170);
         }
         return this._length;
      }
      ...
      {
         this._x = -this._x;
         this.var_171 = -this.var_171;
         this.var_170 = -this.var_170;
      }
      ...
      public function add(param1:IVector3d) : void
      {
         ...
         this._x += param1.x;
         this.var_171 += param1.y;
         this.var_170 += param1.z;
         this._length = NaN;
      }
